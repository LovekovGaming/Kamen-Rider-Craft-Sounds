...
execute if score @s krc.henshin-stage matches 1..2 if entity @n[type=item,distance=..5,tag=valid] run playsound kamenridercraft:chemy_card_in player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
