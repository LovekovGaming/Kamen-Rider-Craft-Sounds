...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid,tag=twilight_card] run playsound kamenridercraft:brightness_link player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid,tag=!twilight_card] if score @s krc.configs.majade_link matches 0 run playsound kamenridercraft:alchemis_link_majade player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid,tag=!twilight_card] if score @s krc.configs.majade_link matches 1 run playsound kamenridercraft:majade_link player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid,tag=twilight_card] run playsound kamenridercraft:darkness_link player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 3..4 if entity @n[type=item,distance=..5,tag=valid] run playsound kamenridercraft:chemy_card_in player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
