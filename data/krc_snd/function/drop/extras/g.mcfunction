...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:goro_wine_bottle run playsound kamenridercraft:g_wine player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
