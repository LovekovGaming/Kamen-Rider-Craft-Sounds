...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:taboo_memory run function krc_snd:play_global {name:"kamenridercraft:taboo_dopant",scope:"henshin_snd"}
