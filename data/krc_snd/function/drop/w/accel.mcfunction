...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:accel_memory run function krc_snd:play_global {name:"kamenridercraft:accel_memory",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:trial_memory run function krc_snd:play_global {name:"kamenridercraft:trial_memory",scope:"henshin_snd"}
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:trial_memory run function krc_snd:play_global {name:"kamenridercraft:trial_memory_press",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:accel_booster_memory run function krc_snd:play_global {name:"kamenridercraft:accel_upgrade",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:trial_memory run function krc_snd:play_global {name:"kamenridercraft:trial_memory_mode",scope:"henshin_snd"}
