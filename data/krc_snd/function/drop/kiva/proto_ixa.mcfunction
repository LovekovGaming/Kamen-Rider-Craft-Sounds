...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:ixa_knuckle run function krc_snd:play_global {name:"kamenridercraft:equip_1986",scope:"henshin_snd"}
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:ixa_knuckle run function krc_snd:play_global {name:"kamenridercraft:ready_1986",scope:"henshin_snd"}
