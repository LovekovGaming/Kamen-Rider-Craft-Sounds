...
execute if entity @n[type=item,distance=..5,tag=valid] unless items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:tatsulot run playsound kamenridercraft:fuestle_set player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @n[type=item,distance=..5,tag=valid] if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:tatsulot run playsound kamenridercraft:tatsulot player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
