...
execute if entity @n[type=item,distance=..5,tag=valid] unless items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:tatsulot run function krc_snd:play_global {name:"kamenridercraft:fuestle_set",scope:"henshin_snd"}
...
execute if entity @n[type=item,distance=..5,tag=valid] if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:tatsulot run function krc_snd:play_global {name:"kamenridercraft:tatsulot",scope:"henshin_snd"}
