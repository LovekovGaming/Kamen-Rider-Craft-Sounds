...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:ixariser run function krc_snd:play_global {name:"kamenridercraft:ixariser",scope:"henshin_snd"}
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:ixariser run function krc_snd:play_global {name:"kamenridercraft:ixariser_key1",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 3 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:ixariser run function krc_snd:play_global {name:"kamenridercraft:ixariser_key2",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 4 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:ixariser run function krc_snd:play_global {name:"kamenridercraft:ixariser_key3",scope:"henshin_snd"}
