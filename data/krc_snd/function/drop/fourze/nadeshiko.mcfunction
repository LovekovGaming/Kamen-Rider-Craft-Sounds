...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:nadeshiko_switch run function krc_snd:play_global {name:"kamenridercraft:fourze_switch1",scope:"henshin_snd"}
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:nadeshiko_switch run function krc_snd:play_global {name:"kamenridercraft:fourze_switch4",scope:"henshin_snd"}
