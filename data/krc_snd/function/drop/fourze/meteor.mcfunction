...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:meteor_storm_switch run playsound kamenridercraft:meteor_storm player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:meteor_switch run playsound kamenridercraft:meteor_ready player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:meteor_storm_switch run playsound kamenridercraft:meteor_on player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
