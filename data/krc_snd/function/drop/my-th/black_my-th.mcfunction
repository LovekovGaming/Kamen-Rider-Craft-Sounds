...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5] contents kamenridercraft:ride_x_eggs_1_origin run playsound kamenridercraft:born_buckle_on player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5] contents kamenridercraft:ride_x_eggs_1_origin run playsound kamenridercraft:x-eggs_in_zodiac player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute as @n[type=item,distance=..5] if items entity @s contents kamenridercraft:ride_x_eggs_1_origin run function krc_snd:drop/common/return_item
