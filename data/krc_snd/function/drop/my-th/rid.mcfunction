...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5] contents kamenridercraft:ride_x_eggs_1 run function krc_snd:play_global {name:"kamenridercraft:born_buckle_on",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5] contents kamenridercraft:ride_x_eggs_1 run function krc_snd:play_global {name:"kamenridercraft:x-eggs_in_zodiac",scope:"henshin_snd"}
