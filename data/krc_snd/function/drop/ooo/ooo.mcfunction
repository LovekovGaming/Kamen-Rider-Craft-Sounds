...
execute unless score @s krc.henshin-stage matches 1.. if predicate krc_core:sneaking if entity @n[type=item,distance=..5,tag=medal] run function krc_snd:play_global {name:"kamenridercraft:medal_toss",scope:"henshin_snd"}
...
execute unless score @s krc.henshin-stage matches 1.. unless predicate krc_core:sneaking if entity @n[type=item,distance=..5,tag=medal] run function krc_snd:play_global {name:"kamenridercraft:medal_in",scope:"henshin_snd"}
