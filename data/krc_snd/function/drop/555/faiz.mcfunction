...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=blaster,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:faiz_key1",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=blaster,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:faiz_key2",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 3 if entity @n[type=item,distance=..5,tag=blaster,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:faiz_key3",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 4 if entity @n[type=item,distance=..5,tag=blaster,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:faiz_key4",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=!blaster,tag=valid] contents kamenridercraft:faiz_phone run function krc_snd:play_global {name:"kamenridercraft:blaster_start",scope:"henshin_snd"}
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=!blaster,tag=valid] contents kamenridercraft:faiz_blaster unless predicate krc_core:sneaking run function krc_snd:play_global {name:"kamenridercraft:blaster_start",scope:"henshin_snd"}
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=!blaster,tag=valid] contents kamenridercraft:faiz_blaster if predicate krc_core:sneaking run function krc_snd:play_global {name:"kamenridercraft:awakening",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=!blaster,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:faiz_key1",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 3 if entity @n[type=item,distance=..5,tag=!blaster,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:faiz_key2",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 4 if entity @n[type=item,distance=..5,tag=!blaster,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:faiz_key3",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 5 if entity @n[type=item,distance=..5,tag=!blaster,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:faiz_standing_by",scope:"henshin_snd"}
