...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=blaster,tag=valid] run playsound kamenridercraft:faiz_key1 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=blaster,tag=valid] run playsound kamenridercraft:faiz_key2 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 3 if entity @n[type=item,distance=..5,tag=blaster,tag=valid] run playsound kamenridercraft:faiz_key3 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 4 if entity @n[type=item,distance=..5,tag=blaster,tag=valid] run playsound kamenridercraft:faiz_key4 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=!blaster,tag=valid] contents kamenridercraft:faiz_phone run playsound kamenridercraft:blaster_start player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=!blaster,tag=valid] contents kamenridercraft:faiz_blaster unless predicate krc_core:sneaking run playsound kamenridercraft:blaster_start player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=!blaster,tag=valid] contents kamenridercraft:faiz_blaster if predicate krc_core:sneaking run playsound kamenridercraft:awakening player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=!blaster,tag=valid] run playsound kamenridercraft:faiz_key1 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 3 if entity @n[type=item,distance=..5,tag=!blaster,tag=valid] run playsound kamenridercraft:faiz_key2 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 4 if entity @n[type=item,distance=..5,tag=!blaster,tag=valid] run playsound kamenridercraft:faiz_key3 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 5 unless predicate krc_core:heisei/faiz_armor if items entity @n[type=item,distance=..5,tag=!blaster,tag=valid] contents kamenridercraft:faiz_blaster if predicate krc_core:sneaking run tag @s add blaster_standing_by
execute if score @s krc.henshin-stage matches 5 unless predicate krc_core:heisei/faiz_armor if items entity @n[type=item,distance=..5,tag=!blaster,tag=valid] contents kamenridercraft:faiz_blaster if predicate krc_core:sneaking run scoreboard players set @s krc.henshin-stage 6
execute if score @s krc.henshin-stage matches 5 if entity @n[type=item,distance=..5,tag=!blaster,tag=valid] run playsound kamenridercraft:faiz_standing_by player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
