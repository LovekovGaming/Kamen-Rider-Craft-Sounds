...
execute if score @s krc.henshin-stage matches 2 if score @s krc.configs.ryuki_type matches 0 if entity @n[type=item,distance=..5,tag=valid] run playsound kamenridercraft:draw_advent_card_ryuga player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
