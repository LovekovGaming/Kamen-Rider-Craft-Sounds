...
execute if score @s krc.henshin-stage matches 1 if score @s krc.form1n matches 3 if entity @n[type=item,distance=..5,tag=valid,tag=evol_trigger] run playsound kamenridercraft:over_over_the_revolution player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid,tag=evol_trigger] run playsound kamenridercraft:over_the_evolution player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
# execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid,tag=evol_trigger] run playsound kamenridercraft:hazard_trigger player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 3 if entity @n[type=item,distance=..5,tag=valid] run playsound kamenridercraft:fullbottle_turn player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 4 if entity @n[type=item,distance=..5,tag=valid,tag=!evol-x_bottle] run playsound kamenridercraft:fullbottle_turn player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 4 if entity @n[type=item,distance=..5,tag=valid,tag=evol-x_bottle] run playsound kamenridercraft:next_phase player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 5..6 if entity @n[type=item,distance=..5,tag=valid,tag=!evol_trigger] run playsound kamenridercraft:evolbottle_in player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!evol_trigger] krc.henshin-stage matches 7 if entity @n[type=item,distance=..5,tag=valid,tag=!evol_trigger] run playsound kamenridercraft:evol_driver_standby_2_start player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
