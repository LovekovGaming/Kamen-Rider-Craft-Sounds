...
execute if score @s krc.henshin-stage matches 1 if predicate krc_core:sneaking if entity @n[type=item,distance=..5,tag=valid] if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:taka_full_bottle run function krc_snd:play_global {name:"kamenridercraft:fullbottle_shake",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid] if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:dragon_sclash_jelly run function krc_snd:play_global {name:"kamenridercraft:dragon_jelly",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid] if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:taka_full_bottle run function krc_snd:play_global {name:"kamenridercraft:charge_bottle",scope:"henshin_snd"}
