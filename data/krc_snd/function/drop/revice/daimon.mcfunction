...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:tri_chimera_vistamp run playsound kamenridercraft:tri_chimera_vistamp player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:tri_chimera_vistamp run playsound kamenridercraft:vistamp_set_chimera player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
