...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:tri_chimera_vistamp run function krc_snd:play_global {name:"kamenridercraft:tri_chimera_vistamp",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:tri_chimera_vistamp run function krc_snd:play_global {name:"kamenridercraft:vistamp_set_chimera",scope:"henshin_snd"}
