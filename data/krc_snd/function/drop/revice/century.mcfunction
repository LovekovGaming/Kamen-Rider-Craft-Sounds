...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:cyclotron_driver_core run function krc_snd:play_global {name:"kamenridercraft:cyclotron_driver_active",scope:"henshin_snd"}
