...
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:triceratops_zetsumerisekey",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 3 if predicate krc_core:sneaking if entity @n[type=item,distance=..5,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:triceratops_ability",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 4 if predicate krc_core:sneaking if entity @n[type=item,distance=..5,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:triceratops_ability_2",scope:"henshin_snd"}
