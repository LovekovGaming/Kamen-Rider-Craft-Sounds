...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:attache_calibur run playsound kamenridercraft:blade_on_big_bang player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:attache_shotgun run playsound kamenridercraft:bullet_on_big_bang player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:attache_arrow run playsound kamenridercraft:arrow_on_big_bang player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:authorise_buster run playsound kamenridercraft:blade_on_big_bang player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:progrise_hopper_blade run playsound kamenridercraft:blade_on_big_bang player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:progrise_hopper_blade_naginata run playsound kamenridercraft:blade_on_big_bang player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:thousand_jacker run playsound kamenridercraft:blade_on_big_bang player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:shot_riser_gun run playsound kamenridercraft:bullet_on_big_bang player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:zaia_slashriser_sword run playsound kamenridercraft:blade_on_big_bang player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:shot_abaddo_gun run playsound kamenridercraft:bullet_on_big_bang player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:slash_abaddo_sword run playsound kamenridercraft:blade_on_big_bang player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
