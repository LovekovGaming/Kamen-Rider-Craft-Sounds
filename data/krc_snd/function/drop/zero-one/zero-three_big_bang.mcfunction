...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:attache_shotgun run function krc_snd:play_global {name:"kamenridercraft:bullet_on_big_bang",scope:"henshin_snd"}
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:attache_arrow run function krc_snd:play_global {name:"kamenridercraft:arrow_on_big_bang",scope:"henshin_snd"}
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:authorise_buster run function krc_snd:play_global {name:"kamenridercraft:blade_on_big_bang",scope:"henshin_snd"}
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:progrise_hopper_blade run function krc_snd:play_global {name:"kamenridercraft:blade_on_big_bang",scope:"henshin_snd"}
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:progrise_hopper_blade_naginata run function krc_snd:play_global {name:"kamenridercraft:blade_on_big_bang",scope:"henshin_snd"}
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:thousand_jacker run function krc_snd:play_global {name:"kamenridercraft:blade_on_big_bang",scope:"henshin_snd"}
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:shot_riser_gun run function krc_snd:play_global {name:"kamenridercraft:bullet_on_big_bang",scope:"henshin_snd"}
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:zaia_slashriser_sword run function krc_snd:play_global {name:"kamenridercraft:blade_on_big_bang",scope:"henshin_snd"}
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:shot_abaddo_gun run function krc_snd:play_global {name:"kamenridercraft:bullet_on_big_bang",scope:"henshin_snd"}
...
execute if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:slash_abaddo_sword run function krc_snd:play_global {name:"kamenridercraft:blade_on_big_bang",scope:"henshin_snd"}
