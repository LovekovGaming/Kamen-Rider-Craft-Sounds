...
execute if score @s krc.henshin-stage matches 1..3 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:frappeis_gochizo run playsound kamenridercraft:frappeis_stir player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 4 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:frappeis_gochizo run playsound kamenridercraft:frappe_on player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 3 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:chocorappa_gochizo run playsound kamenridercraft:dessert_on_chocorappa player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 4 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:chocorappa_gochizo run playsound kamenridercraft:chocorappa_press player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
