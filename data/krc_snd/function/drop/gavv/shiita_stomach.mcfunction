...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:shiita_mimic_key run function krc_snd:play_global {name:"kamenridercraft:mimic_key_eject",scope:"henshin_snd"}
