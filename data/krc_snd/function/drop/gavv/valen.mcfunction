...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:gochizo_set",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:valenbuster_close",scope:"henshin_snd"}
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid] if predicate krc_core:sneaking run function krc_snd:play_global {name:"kamenridercraft:gochizo_shock",scope:"henshin_snd"}
