...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid] unless items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:puddinte_gochizo run playsound kamenridercraft:cup_on player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:puddinte_gochizo run playsound kamenridercraft:dessert_on player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:puddinte_gochizo run playsound kamenridercraft:dish_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
