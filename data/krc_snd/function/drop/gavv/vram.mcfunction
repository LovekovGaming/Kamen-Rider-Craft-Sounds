...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid] unless items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:puddinte_gochizo run function krc_snd:play_global {name:"kamenridercraft:cup_on",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:puddinte_gochizo run function krc_snd:play_global {name:"kamenridercraft:dessert_on",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:puddinte_gochizo run function krc_snd:play_global {name:"kamenridercraft:dish_up",scope:"henshin_snd"}
