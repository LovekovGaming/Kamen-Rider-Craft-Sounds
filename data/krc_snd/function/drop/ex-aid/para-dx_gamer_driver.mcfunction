...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid,tag=knock_out_fighter_2] run function krc_snd:play_global {name:"kamenridercraft:knock_out_fighter_2_activate",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 3 if entity @n[type=item,distance=..5,tag=valid,tag=!knock_out_fighter_2] run function krc_snd:play_global {name:"kamenridercraft:dual_gashat",scope:"henshin_snd"}
