...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:ocean_history_wonder_ride_book run playsound kamenridercraft:ocean_history_open player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:ocean_history_wonder_ride_book run playsound kamenridercraft:ocean_history_story player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 3 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:ocean_history_wonder_ride_book run playsound kamenridercraft:wrb_insert player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 4 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:jikokuken_kaiji run playsound kamenridercraft:kaiji_blade_out player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
