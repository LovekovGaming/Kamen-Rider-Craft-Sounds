...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:ocean_history_wonder_ride_book run function krc_snd:play_global {name:"kamenridercraft:ocean_history_open",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:ocean_history_wonder_ride_book run function krc_snd:play_global {name:"kamenridercraft:ocean_history_story",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 3 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:ocean_history_wonder_ride_book run function krc_snd:play_global {name:"kamenridercraft:wrb_insert",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 4 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:jikokuken_kaiji run function krc_snd:play_global {name:"kamenridercraft:kaiji_blade_out",scope:"henshin_snd"}
