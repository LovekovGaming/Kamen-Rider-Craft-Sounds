...
execute if items entity @s container.* kamenridercraft:rouze_absorber as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:absorb_capricorn run tag @s add valid
...
execute if entity @n[type=item,distance=..5,tag=gorider_card] run function krc_snd:drop/common/equip_armor {slot: "armor.feet", item: "kamenridercraft:typhoon_aorider"}
...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:absorb_capricorn run playsound kamenridercraft:absorb_queen player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=evolution] run playsound kamenridercraft:king_start player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
