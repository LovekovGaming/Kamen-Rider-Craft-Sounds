...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:absorb_serpent run function krc_snd:play_global {name:"kamenridercraft:absorb_queen",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:evolution_giraffa run function krc_snd:play_global {name:"kamenridercraft:king_start",scope:"henshin_snd"}
