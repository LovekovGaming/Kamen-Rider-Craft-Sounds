...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:nextshift run playsound kamenridercraft:start_engine player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:nextshift run playsound kamenridercraft:shift_car_in player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
