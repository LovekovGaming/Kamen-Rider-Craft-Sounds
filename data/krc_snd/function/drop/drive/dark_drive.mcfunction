...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:nextshift run function krc_snd:play_global {name:"kamenridercraft:start_engine",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:nextshift run function krc_snd:play_global {name:"kamenridercraft:shift_car_in",scope:"henshin_snd"}
