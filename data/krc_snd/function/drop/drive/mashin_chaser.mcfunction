...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:break_gunner run playsound kamenridercraft:break_gunner_press player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:rhino_super_viral_core run playsound kamenridercraft:tune_rhino player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
