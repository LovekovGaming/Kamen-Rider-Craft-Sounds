...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:tokujoka_key run function krc_snd:play_global {name:"kamenridercraft:mach_driver_open",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:tokujoka_key run function krc_snd:play_global {name:"kamenridercraft:tokujoka_key",scope:"henshin_snd"}
