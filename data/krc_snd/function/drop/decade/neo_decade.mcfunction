...
execute as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:k_touch_21 run tag @s add valid
execute as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:k_touch_21 run tag @s add k-touch
...
execute as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:w_card run tag @s add kamen_ride
execute as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:ooo_card run tag @s add kamen_ride
execute as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:fourze_card run tag @s add kamen_ride
execute as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:wizard_card run tag @s add kamen_ride
execute as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:gaim_card run tag @s add kamen_ride
execute as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:drive_card run tag @s add kamen_ride
execute as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:ghost_card run tag @s add kamen_ride
execute as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:ex_aid_card run tag @s add kamen_ride
execute as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:build_card run tag @s add kamen_ride
execute as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:zi_o_card run tag @s add kamen_ride
...
execute if score @s krc.form1n matches 3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:zero_two_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:grand_zi_o_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:build_genius_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:ex_aid_muteki_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:ghost_mugen_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:drive_tridoron_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:gaim_kiwami_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:wizard_infinity_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:fourze_cosmic_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:ooo_putotyra_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:w_xtreme_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 2..3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:kiva_emperor_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 2..3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:den_o_liner_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 2..3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:den_o_chou_climax_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 2..3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:kabuto_hyper_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 2..3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:armed_hibiki_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 2..3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:blade_king_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 2..3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:faiz_blaster_card run tag @s add final_kamen_ride
execute if score @s krc.form1n matches 2..3 as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:ryuki_survive_card run tag @s add final_kamen_ride
...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:w_xtreme_card run playsound kamenridercraft:k-touch_double player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:w_xtreme_card run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.double","color":"green"}
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:ooo_putotyra_card run playsound kamenridercraft:k-touch_ooo player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:ooo_putotyra_card run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar ["",{"translate":"sound.kamenridercraft.decade.ooo","color":"red"}]
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:fourze_cosmic_card run playsound kamenridercraft:k-touch_fourze player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:fourze_cosmic_card run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.fourze","color":"gold"}
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:wizard_infinity_card run playsound kamenridercraft:k-touch_wizard player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:wizard_infinity_card run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.wizard","color":"red"}
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:gaim_kiwami_card run playsound kamenridercraft:k-touch_gaim player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:gaim_kiwami_card run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.gaim","color":"gold"}
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:drive_tridoron_card run playsound kamenridercraft:k-touch_drive player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:drive_tridoron_card run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.drive","color":"red"}
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:ghost_mugen_card run playsound kamenridercraft:k-touch_ghost player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:ghost_mugen_card run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.ghost","color":"gold"}
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:ex_aid_muteki_card run playsound kamenridercraft:k-touch_ex-aid player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:ex_aid_muteki_card run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.ex-aid","color":"light_purple"}
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:build_genius_card run playsound kamenridercraft:k-touch_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:build_genius_card run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.build","color":"red"}
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:grand_zi_o_card run playsound kamenridercraft:k-touch_zi-o player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:grand_zi_o_card run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.zi-o","color":"light_purple"}
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:zero_two_card run playsound kamenridercraft:k-touch_zero-one player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=final_kamen_ride] contents kamenridercraft:zero_two_card run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.zero-one","color":"green"}
...
execute if score @s krc.henshin-stage matches 1 unless predicate krc_core:sneaking if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run playsound kamenridercraft:k-touch_21_start player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 unless predicate krc_core:sneaking if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.k-touch_21","color":"#ec008c"}
...
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.double","color":"green"}
execute if score @s krc.henshin-stage matches 3 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar ["",{"translate":"sound.kamenridercraft.decade.ooo","color":"red"}]
execute if score @s krc.henshin-stage matches 4 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.fourze","color":"gold"}
execute if score @s krc.henshin-stage matches 5 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.wizard","color":"red"}
execute if score @s krc.henshin-stage matches 6 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.gaim","color":"gold"}
execute if score @s krc.henshin-stage matches 7 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.drive","color":"red"}
execute if score @s krc.henshin-stage matches 8 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.ghost","color":"gold"}
execute if score @s krc.henshin-stage matches 9 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.ex-aid","color":"light_purple"}
execute if score @s krc.henshin-stage matches 10 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.build","color":"red"}
execute if score @s krc.henshin-stage matches 11 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.zi-o","color":"light_purple"}
execute if score @s krc.henshin-stage matches 12 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.decade.zero-one","color":"green"}
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run playsound kamenridercraft:k-touch_double player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 3 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run playsound kamenridercraft:k-touch_ooo player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 4 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run playsound kamenridercraft:k-touch_fourze player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 5 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run playsound kamenridercraft:k-touch_wizard player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 6 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run playsound kamenridercraft:k-touch_gaim player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 7 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run playsound kamenridercraft:k-touch_drive player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 8 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run playsound kamenridercraft:k-touch_ghost player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 9 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run playsound kamenridercraft:k-touch_ex-aid player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 10 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run playsound kamenridercraft:k-touch_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 11 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run playsound kamenridercraft:k-touch_zi-o player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 12 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run playsound kamenridercraft:k-touch_zero-one player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 12 if entity @n[type=item,distance=..5,tag=valid,tag=k-touch] run advancement grant @s only krc_snd:henshin/decade/k-touch_standby 1
