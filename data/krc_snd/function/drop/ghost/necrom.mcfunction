...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid,tag=necrom_eyecon] run playsound kamenridercraft:eyecon_press_necrom player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid,tag=!necrom_eyecon] unless items entity @n[type=item,distance=..5,tag=valid,tag=!necrom_eyecon] contents kamenridercraft:yujou_burst_ghost_eyecon run playsound kamenridercraft:eyecon_press player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=!necrom_eyecon] contents kamenridercraft:yujou_burst_ghost_eyecon run playsound kamenridercraft:eyecon_press_yujou_burst player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid] run playsound kamenridercraft:mega_ulorder_eyecon_in player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.henshin-stage matches 3 if entity @n[type=item,distance=..5,tag=valid,tag=necrom_eyecon] run playsound kamenridercraft:mega_ulorder_loading player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.henshin-stage matches 3 if entity @n[type=item,distance=..5,tag=valid,tag=!necrom_eyecon] run playsound kamenridercraft:mega_ulorder_button player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
