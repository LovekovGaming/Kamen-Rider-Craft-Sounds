...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid,tag=necrom_eyecon] run function krc_snd:play_global {name:"kamenridercraft:eyecon_press_necrom",scope:"henshin_snd"}
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid,tag=!necrom_eyecon] unless items entity @n[type=item,distance=..5,tag=valid,tag=!necrom_eyecon] contents kamenridercraft:yujou_burst_ghost_eyecon run function krc_snd:play_global {name:"kamenridercraft:eyecon_press",scope:"henshin_snd"}
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,tag=valid,tag=!necrom_eyecon] contents kamenridercraft:yujou_burst_ghost_eyecon run function krc_snd:play_global {name:"kamenridercraft:eyecon_press_yujou_burst",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:mega_ulorder_eyecon_in",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 3 if entity @n[type=item,distance=..5,tag=valid,tag=necrom_eyecon] run function krc_snd:play_global {name:"kamenridercraft:mega_ulorder_loading",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 3 if entity @n[type=item,distance=..5,tag=valid,tag=!necrom_eyecon] run function krc_snd:play_global {name:"kamenridercraft:mega_ulorder_button",scope:"henshin_snd"}
