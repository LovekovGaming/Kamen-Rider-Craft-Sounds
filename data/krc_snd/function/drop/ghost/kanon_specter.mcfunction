...
execute as @n[type=item,distance=..5,predicate=krc_snd:valid_item] if items entity @s contents kamenridercraft:specter_ghost_eyecon run tag @s add specter_eyecon
...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid] run playsound kamenridercraft:ghost_driver_open player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid,tag=!necrom_eyecon] run playsound kamenridercraft:eyecon_press player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid,tag=necrom_eyecon] run playsound kamenridercraft:eyecon_press_necrom player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.henshin-stage matches 3 if entity @n[type=item,distance=..5,tag=valid] run playsound kamenridercraft:eyecon_insert player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.henshin-stage matches 4 if entity @n[type=item,distance=..5,tag=valid] run playsound kamenridercraft:ghost_driver_close player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.henshin-stage matches 4 unless predicate krc_core:sneaking if entity @n[type=item,distance=..5,tag=valid,tag=!ghost_eyecon,tag=!specter_eyecon,tag=!necrom_eyecon] unless items entity @n[type=item,distance=..5,tag=valid,tag=!specter_eyecon] contents kamenridercraft:ore_specter_ghost_eyecon run advancement grant @s only krc_snd:henshin/ghost/ghost_standby 1
execute if score @s krc.henshin-stage matches 4 if predicate krc_core:sneaking if entity @n[type=item,distance=..5,tag=valid,tag=!ghost_eyecon,tag=!specter_eyecon,tag=!necrom_eyecon] unless items entity @n[type=item,distance=..5,tag=valid,tag=!specter_eyecon] contents kamenridercraft:ore_specter_ghost_eyecon run advancement grant @s only krc_snd:henshin/ghost/specter_standby 1
...
execute if score @s krc.henshin-stage matches 4 if entity @n[type=item,distance=..5,tag=valid,tag=specter_eyecon] run advancement grant @s only krc_snd:henshin/ghost/specter_standby 1
...
execute if score @s krc.henshin-stage matches 5 if entity @n[type=item,distance=..5,tag=valid] run playsound kamenridercraft:ghost_driver_pull player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
