...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:ghost_driver_open",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid,tag=!necrom_eyecon] run function krc_snd:play_global {name:"kamenridercraft:eyecon_press",scope:"henshin_snd"}
execute if score @s krc.henshin-stage matches 2 if entity @n[type=item,distance=..5,tag=valid,tag=necrom_eyecon] run function krc_snd:play_global {name:"kamenridercraft:eyecon_press_necrom",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 3 if entity @n[type=item,distance=..5,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:eyecon_insert",scope:"henshin_snd"}
execute if score @s krc.henshin-stage matches 4 if entity @n[type=item,distance=..5,tag=valid] run function krc_snd:play_global {name:"kamenridercraft:ghost_driver_close",scope:"henshin_snd"}
