...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:sirius_card_gazer_zero run playsound kamenridercraft:gazer_zero_sign_in player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
