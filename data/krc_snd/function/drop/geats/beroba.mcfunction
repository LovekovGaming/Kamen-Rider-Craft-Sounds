...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid] unless items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:beroba_black_raise_riser_card run playsound kamenridercraft:beroba_set player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid] if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:beroba_black_raise_riser_card run playsound kamenridercraft:premium_beroba_set player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
