...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid] unless items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:beroba_black_raise_riser_card run function krc_snd:play_global {name:"kamenridercraft:beroba_set",scope:"henshin_snd"}
...
execute if score @s krc.henshin-stage matches 1 if entity @n[type=item,distance=..5,tag=valid] if items entity @n[type=item,distance=..5,tag=valid] contents kamenridercraft:beroba_black_raise_riser_card run function krc_snd:play_global {name:"kamenridercraft:premium_beroba_set",scope:"henshin_snd"}
