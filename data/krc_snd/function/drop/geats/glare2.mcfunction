...
execute if score @s krc.henshin-stage matches 1 if items entity @n[type=item,distance=..5,predicate=krc_snd:valid_item] contents kamenridercraft:providence_card_glare2 run function krc_snd:play_global {name:"kamenridercraft:glare2_login",scope:"henshin_snd"}
