...
execute if score @s krc.henshin-stage matches 1 unless predicate krc_core:heisei/kabuto_armor if entity @n[type=item,distance=..5,tag=dark_kabuto_zecter] run playsound kamenridercraft:dark_kabuto_zecter_appear player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 1 if predicate krc_core:heisei/kabuto_armor if entity @n[type=item,distance=..5,tag=dark_kabuto_zecter] run playsound kamenridercraft:dark_kabuto_cast_off_start player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
