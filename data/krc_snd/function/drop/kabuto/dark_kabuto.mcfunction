...
execute if score @s krc.henshin-stage matches 1 unless predicate krc_core:heisei/kabuto_armor if entity @n[type=item,distance=..5,tag=dark_kabuto_zecter] run function krc_snd:play_global {name:"kamenridercraft:dark_kabuto_zecter_appear",scope:"henshin_snd"}
execute if score @s krc.henshin-stage matches 1 if predicate krc_core:heisei/kabuto_armor if entity @n[type=item,distance=..5,tag=dark_kabuto_zecter] run function krc_snd:play_global {name:"kamenridercraft:dark_kabuto_cast_off_start",scope:"henshin_snd"}
