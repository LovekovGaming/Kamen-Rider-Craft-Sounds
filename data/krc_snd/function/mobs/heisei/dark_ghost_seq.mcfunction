...
execute at @e[type=kamenridercraft:dark_ghost,tag=sounded_2,tag=sound_active,scores={krc.seq1=46},nbt={ArmorItems:[{components:{"minecraft:custom_data":{slot_tex2:"kamenridercraft:napoleon_ghost_eyecon"}}}]}] run playsound kamenridercraft:napoleon_eyecon hostile @a[scores={krc.configs.mob_snd=1}] ~ ~1 ~
execute at @e[type=kamenridercraft:dark_ghost,tag=sounded_2,tag=sound_active,scores={krc.seq1=46},nbt={ArmorItems:[{components:{"minecraft:custom_data":{slot_tex2:"kamenridercraft:ikkyu_ghost_eyecon"}}}]}] run playsound kamenridercraft:ikkyu_eyecon hostile @a[scores={krc.configs.mob_snd=1}] ~ ~1 ~
execute at @e[type=kamenridercraft:dark_ghost,tag=sounded_2,tag=sound_active,scores={krc.seq1=46},nbt={ArmorItems:[{components:{"minecraft:custom_data":{slot_tex2:"kamenridercraft:pythagoras_ghost_eyecon"}}}]}] run playsound kamenridercraft:pythagoras_eyecon hostile @a[scores={krc.configs.mob_snd=1}] ~ ~1 ~
