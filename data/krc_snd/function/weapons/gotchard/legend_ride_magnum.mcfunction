...
execute unless entity @n[type=arrow,nbt={HasBeenShot:false},distance=..2] as @n[type=kamenridercraft:rider_summon,tag=!sounded,distance=..2] run tag @s add sounded
execute unless entity @n[type=arrow,nbt={HasBeenShot:false},distance=..2] if entity @s[tag=legendride] run function krc_snd:play_global {name:"kamenridercraft:legendride",scope:"henshin_snd"}
execute unless entity @n[type=arrow,nbt={HasBeenShot:false},distance=..2] if entity @s[tag=legendride_duo] run function krc_snd:play_global {name:"kamenridercraft:legendride_duo",scope:"henshin_snd"}
execute unless entity @n[type=arrow,nbt={HasBeenShot:false},distance=..2] if entity @s[tag=legendride_trio] run function krc_snd:play_global {name:"kamenridercraft:legendride_trio",scope:"henshin_snd"}
execute unless entity @n[type=arrow,nbt={HasBeenShot:false},distance=..2] if entity @s[tag=legendride_massimo] run function krc_snd:play_global {name:"kamenridercraft:legendride_massimo",scope:"henshin_snd"}
