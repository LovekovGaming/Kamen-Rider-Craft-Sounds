...
execute unless score @s krc.form1n matches 5..6 run function krc_snd:play_global {name:"kamenridercraft:rekka_battou",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 5 run function krc_snd:play_global {name:"kamenridercraft:saber_battou",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 6 run function krc_snd:play_global {name:"kamenridercraft:wonder_almighty",scope:"henshin_snd"}
