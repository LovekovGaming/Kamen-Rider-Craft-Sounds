...
execute if score @s krc.seq1 matches 65 if score @s krc.form1n matches 0 run function krc_snd:play_global {name:"kamenridercraft:saikou_henshin",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 65 if score @s krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:saikou_shadow",scope:"henshin_snd"}
