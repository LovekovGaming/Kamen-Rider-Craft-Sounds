...
execute if score @s[tag=!ju_de_go_go] krc.seq1 matches 93 run function krc_snd:play_global {name:"kamenridercraft:slash_henshin_sword",scope:"henshin_snd"}
execute if score @s[tag=ju_de_go_go] krc.seq1 matches 93 run function krc_snd:play_global {name:"kamenridercraft:slash_henshin_gun",scope:"henshin_snd"}
