...
execute if score @s[tag=!ju_de_go_go] krc.seq1 matches 93 run playsound kamenridercraft:slash_henshin_sword player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=ju_de_go_go] krc.seq1 matches 93 run playsound kamenridercraft:slash_henshin_gun player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
