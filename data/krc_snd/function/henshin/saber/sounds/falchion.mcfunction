...
execute if score @s krc.seq1 matches 80 if score @s krc.form1n matches 0 run function krc_snd:play_global {name:"kamenridercraft:eternal_phoenix",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 80 if score @s krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:eternal_wonder",scope:"henshin_snd"}
