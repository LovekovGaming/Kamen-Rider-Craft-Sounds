...
execute if score @s krc.seq1 matches 80 if score @s krc.form1n matches 0 run playsound kamenridercraft:eternal_phoenix player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 80 if score @s krc.form1n matches 1 run playsound kamenridercraft:eternal_wonder player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
