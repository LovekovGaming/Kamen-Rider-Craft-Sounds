...
execute unless score @s krc.form1n matches 7 run playsound kamenridercraft:ikazuchi_battou player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 7 run playsound kamenridercraft:gekkou_ikazuchi_battou player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
