...
execute if score @s krc.seq1 matches 15 if score @s krc.form1n matches 0 run playsound kamenridercraft:rider_chaser player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 15 if score @s krc.form1n matches 1 run playsound kamenridercraft:tire_koukan_mach player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 74 if score @s krc.form1n matches 1 run playsound kamenridercraft:hayai player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
