...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 15 run playsound kamenridercraft:rider_dead_heat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 1 if score @s krc.seq1 matches 15 run playsound kamenridercraft:chou_dead_heat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
