...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 15 run function krc_snd:play_global {name:"kamenridercraft:rider_dead_heat",scope:"henshin_snd"}
execute if score @s krc.form1n matches 1 if score @s krc.seq1 matches 15 run function krc_snd:play_global {name:"kamenridercraft:chou_dead_heat",scope:"henshin_snd"}
