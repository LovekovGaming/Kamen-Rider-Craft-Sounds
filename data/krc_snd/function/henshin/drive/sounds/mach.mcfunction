...
execute if score @s krc.form1n matches 0 if score @s krc.form2n matches 0 if score @s krc.seq1 matches 15 run playsound kamenridercraft:rider_mach player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 1 if score @s krc.form2n matches 0 if score @s krc.seq1 matches 15 run playsound kamenridercraft:rider_dead_heat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 2 if score @s krc.form2n matches 0 if score @s krc.seq1 matches 15 run playsound kamenridercraft:rider_chaser player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 3 if score @s krc.form2n matches 0 if score @s krc.seq1 matches 15 run playsound kamenridercraft:mach_chaser player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 4 if score @s krc.form2n matches 0 if score @s krc.seq1 matches 15 run playsound kamenridercraft:chou_dead_heat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 1..4 if score @s krc.seq1 matches 15 run playsound kamenridercraft:signal_koukan player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 5..8 if score @s krc.seq1 matches 15 run playsound kamenridercraft:tire_koukan_mach player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 1 if score @s krc.seq1 matches 85 run playsound kamenridercraft:magarl player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 2 if score @s krc.seq1 matches 85 run playsound kamenridercraft:kaksarn player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 3 if score @s krc.seq1 matches 85 run playsound kamenridercraft:tomarle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 4 if score @s krc.seq1 matches 85 run playsound kamenridercraft:kikern player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 5 if score @s krc.seq1 matches 74 run playsound kamenridercraft:moerl player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 6 if score @s krc.seq1 matches 74 run playsound kamenridercraft:mazerl player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 7 if score @s krc.seq1 matches 74 run playsound kamenridercraft:arabull player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 8 if score @s krc.seq1 matches 74 run playsound kamenridercraft:naorl player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
