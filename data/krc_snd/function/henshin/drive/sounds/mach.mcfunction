...
execute if score @s krc.form1n matches 0 if score @s krc.form2n matches 0 if score @s krc.seq1 matches 15 run function krc_snd:play_global {name:"kamenridercraft:rider_mach",scope:"henshin_snd"}
execute if score @s krc.form1n matches 1 if score @s krc.form2n matches 0 if score @s krc.seq1 matches 15 run function krc_snd:play_global {name:"kamenridercraft:rider_dead_heat",scope:"henshin_snd"}
execute if score @s krc.form1n matches 2 if score @s krc.form2n matches 0 if score @s krc.seq1 matches 15 run function krc_snd:play_global {name:"kamenridercraft:rider_chaser",scope:"henshin_snd"}
execute if score @s krc.form1n matches 3 if score @s krc.form2n matches 0 if score @s krc.seq1 matches 15 run function krc_snd:play_global {name:"kamenridercraft:mach_chaser",scope:"henshin_snd"}
execute if score @s krc.form1n matches 4 if score @s krc.form2n matches 0 if score @s krc.seq1 matches 15 run function krc_snd:play_global {name:"kamenridercraft:chou_dead_heat",scope:"henshin_snd"}
...
execute if score @s krc.form2n matches 1..4 if score @s krc.seq1 matches 15 run function krc_snd:play_global {name:"kamenridercraft:signal_koukan",scope:"henshin_snd"}
...
execute if score @s krc.form2n matches 5..8 if score @s krc.seq1 matches 15 run function krc_snd:play_global {name:"kamenridercraft:tire_koukan_mach",scope:"henshin_snd"}
execute if score @s krc.form2n matches 1 if score @s krc.seq1 matches 85 run function krc_snd:play_global {name:"kamenridercraft:magarl",scope:"henshin_snd"}
...
execute if score @s krc.form2n matches 2 if score @s krc.seq1 matches 85 run function krc_snd:play_global {name:"kamenridercraft:kaksarn",scope:"henshin_snd"}
...
execute if score @s krc.form2n matches 3 if score @s krc.seq1 matches 85 run function krc_snd:play_global {name:"kamenridercraft:tomarle",scope:"henshin_snd"}
...
execute if score @s krc.form2n matches 4 if score @s krc.seq1 matches 85 run function krc_snd:play_global {name:"kamenridercraft:kikern",scope:"henshin_snd"}
...
execute if score @s krc.form2n matches 5 if score @s krc.seq1 matches 74 run function krc_snd:play_global {name:"kamenridercraft:moerl",scope:"henshin_snd"}
...
execute if score @s krc.form2n matches 6 if score @s krc.seq1 matches 74 run function krc_snd:play_global {name:"kamenridercraft:mazerl",scope:"henshin_snd"}
...
execute if score @s krc.form2n matches 7 if score @s krc.seq1 matches 74 run function krc_snd:play_global {name:"kamenridercraft:arabull",scope:"henshin_snd"}
...
execute if score @s krc.form2n matches 8 if score @s krc.seq1 matches 74 run function krc_snd:play_global {name:"kamenridercraft:naorl",scope:"henshin_snd"}
