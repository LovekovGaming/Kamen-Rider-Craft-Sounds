...
execute if score @s krc.seq1 matches 1 run playsound kamenridercraft:drive_detransform player @a[scores={krc.configs.detransform_snd=1}] ~ ~1 ~

execute if score @s krc.seq1 matches ..44 run return 0
playsound kamenridercraft:nice_drive player @a[scores={krc.configs.detransform_snd=1}] ~ ~1 ~
