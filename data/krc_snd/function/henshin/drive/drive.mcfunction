...
execute if score @s krc.form2n matches 0 run function krc_snd:play_global {name:"kamenridercraft:shift_brace",scope:"henshin_snd"}
execute unless score @s krc.form2n matches 0 unless score @s krc.form1n matches 5 run function krc_snd:play_global {name:"kamenridercraft:tire_koukan",scope:"henshin_snd"}
execute if score @s krc.form2n matches 19..21 if score @s krc.form1n matches 5 run function krc_snd:play_global {name:"kamenridercraft:tire_kakimazerl",scope:"henshin_snd"}
execute if score @s krc.form2n matches 22 if score @s krc.form1n matches 5 run function krc_snd:play_global {name:"kamenridercraft:tire_all_kakimazerl",scope:"henshin_snd"}
