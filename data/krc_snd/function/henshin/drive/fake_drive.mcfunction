...
execute if score @s krc.form1n matches 0 run playsound kamenridercraft:fake_drive player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 1 run playsound kamenridercraft:tire_koukan_fake player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
