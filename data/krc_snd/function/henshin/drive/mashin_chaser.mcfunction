...
stopsound @a[scores={krc.configs.weapon_snd=1},distance=..50] player kamenridercraft:break_gunner_shot
...
execute if score @s krc.form1n matches 0 run playsound kamenridercraft:mashin_chaser player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 1 run playsound kamenridercraft:chaser_rhino player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
