...
execute if entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:faiz_complete player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_core:player_transformed=true}] krc.form1n matches 1 run playsound kamenridercraft:flying_attacker player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
