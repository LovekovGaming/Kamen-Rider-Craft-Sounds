...
execute if entity @s[advancements={krc_snd:flags/555/temporary={muez_kitazaki=false}}] run playsound kamenridercraft:faiz_complete player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @s[advancements={krc_snd:flags/555/temporary={muez_kitazaki=true}}] run playsound kamenridercraft:smart_brain_gear_equip player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
