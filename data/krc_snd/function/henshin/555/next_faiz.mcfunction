...
execute if score @s krc.form1n matches 0 unless score Form_Difference krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:faiz_complete",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 0 if score Form_Difference krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:next_faiz_deformation",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:next_faiz_axel",scope:"henshin_snd"}
