...
execute if score @s krc.seq1 matches 21 if score @s krc.configs.psyga_type matches 0 run playsound kamenridercraft:psyga_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 21 if score @s krc.configs.psyga_type matches 1 run playsound kamenridercraft:faiz_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
