...
execute if score @s krc.seq1 matches 21 if score @s krc.configs.psyga_type matches 0 run function krc_snd:play_global {name:"kamenridercraft:psyga_standby",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 21 if score @s krc.configs.psyga_type matches 1 run function krc_snd:play_global {name:"kamenridercraft:faiz_standby",scope:"henshin_snd"}
