advancement revoke @s only krc_snd:henshin/555/faiz_blaster_standby 2
...
execute if score @s krc.seq1 matches 21 run playsound kamenridercraft:blaster_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
