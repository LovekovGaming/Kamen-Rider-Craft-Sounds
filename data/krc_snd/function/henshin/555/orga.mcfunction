...
execute if score @s krc.configs.orga_type matches 0 run playsound kamenridercraft:orga_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.configs.orga_type matches 1 run playsound kamenridercraft:orga_henshin_alt player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
