...
execute if score @s krc.seq1 matches 25 if score @s krc.form1n matches 3.. if score @s krc.configs.blaster_type matches 0 run playsound kamenridercraft:blaster_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 25 if score @s krc.form1n matches 3.. if score @s krc.configs.blaster_type matches 1 run playsound kamenridercraft:blaster_form_alt player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
