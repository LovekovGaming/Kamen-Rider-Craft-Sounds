...
execute if score @s krc.seq1 matches 14 if score @s krc.form1n matches 0 run playsound kamenridercraft:next_faiz_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 14 if score @s krc.form1n matches 0 run scoreboard players set @s krc.seq1 183
execute if score @s krc.seq1 matches 4 if score @s krc.form1n matches 1 run playsound kamenridercraft:next_faiz_axel_start_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
