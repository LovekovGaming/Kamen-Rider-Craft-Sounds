...
execute if score @s krc.seq1 matches 14 if score @s krc.form1n matches 0 run function krc_snd:play_global {name:"kamenridercraft:next_faiz_henshin",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 14 if score @s krc.form1n matches 0 run scoreboard players set @s krc.seq1 183
execute if score @s krc.seq1 matches 4 if score @s krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:next_faiz_axel_start_up",scope:"henshin_snd"}
