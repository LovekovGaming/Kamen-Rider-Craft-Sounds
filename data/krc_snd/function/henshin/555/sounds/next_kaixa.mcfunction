...
execute if score @s krc.seq1 matches 4 if score @s krc.form1n matches 1 run playsound kamenridercraft:next_kaixa_axel_start_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
