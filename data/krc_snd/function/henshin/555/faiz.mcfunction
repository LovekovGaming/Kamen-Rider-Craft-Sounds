...
execute if score @s[advancements={krc_snd:flags/555/temporary={shocker_leader=false}}] krc.form1n matches 0 unless score Form_Difference krc.form1n matches 1..2 run playsound kamenridercraft:faiz_complete player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_snd:flags/555/temporary={shocker_leader=true}}] krc.form1n matches 0 unless score Form_Difference krc.form1n matches 1..2 run playsound kamenridercraft:faiz_henshin_shocker player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 0 if score Form_Difference krc.form1n matches 2 run playsound kamenridercraft:faiz_deformation player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 1 if score Form_Difference krc.form1n matches 0.. unless score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:faiz_complete player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 1 if score Form_Difference krc.form1n matches -1 if entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:faiz_complete player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 1 if score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:faiz_deformation player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 2 run playsound kamenridercraft:faiz_complete player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 3 if score Form_Difference krc.form1n matches 1..4 unless score Form_Difference krc.form1n matches 2..3 run playsound kamenridercraft:blaster_takeoff player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 4 if score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:blaster_discharge player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_snd:flags/555/temporary={blaster_standing_by=false}}] krc.form1n matches 3 unless score Form_Difference krc.form1n matches 1..4 run playsound kamenridercraft:awakening player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_snd:flags/555/temporary={blaster_standing_by=true}}] krc.form1n matches 3 unless score Form_Difference krc.form1n matches 1..4 run playsound kamenridercraft:blaster_form_debut player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_core:player_transformed=false,krc_snd:flags/555/temporary={blaster_standing_by=false}}] krc.form1n matches 4 run playsound kamenridercraft:awakening player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_core:player_transformed=false,krc_snd:flags/555/temporary={blaster_standing_by=true}}] krc.form1n matches 4 run playsound kamenridercraft:blaster_form_debut player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_snd:flags/555/temporary={blaster_standing_by=false}}] krc.form1n matches 5 unless score Form_Difference krc.form1n matches -2..2 run playsound kamenridercraft:awakening player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_snd:flags/555/temporary={blaster_standing_by=true}}] krc.form1n matches 5 unless score Form_Difference krc.form1n matches -2..2 run playsound kamenridercraft:blaster_form_debut player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_snd:flags/555/temporary={blaster_standing_by=false}}] krc.form1n matches 6 unless score Form_Difference krc.form1n matches -3..1 run playsound kamenridercraft:awakening player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_snd:flags/555/temporary={blaster_standing_by=true}}] krc.form1n matches 6 unless score Form_Difference krc.form1n matches -3..1 run playsound kamenridercraft:blaster_form_debut player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_core:player_transformed=false,krc_snd:flags/555/temporary={blaster_standing_by=false}}] krc.form1n matches 7 run playsound kamenridercraft:awakening player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s[advancements={krc_core:player_transformed=false,krc_snd:flags/555/temporary={blaster_standing_by=true}}] krc.form1n matches 7 run playsound kamenridercraft:blaster_form_debut player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 6 if score Form_Difference krc.form1n matches -2..1 unless score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:blaster_takeoff player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 7 if score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:blaster_discharge player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
