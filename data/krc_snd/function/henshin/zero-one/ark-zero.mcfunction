...
execute if score @s krc.form1n matches 0 unless score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:arkrise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 1 unless score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:arkrise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_core:player_transformed=false}] krc.form1n matches 1 if score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:arkrise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 2 unless score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:singurise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 3 unless score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:singurise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 4 run playsound kamenridercraft:ark-one_malgam player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
