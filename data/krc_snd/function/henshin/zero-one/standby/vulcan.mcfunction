...
execute if score @s[tag=authorise] krc.seq1 matches 12 run playsound kamenridercraft:progrisekey_authorise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=overrise] krc.seq1 matches 12 run playsound kamenridercraft:overrise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=allrise] krc.seq1 matches 12 run playsound kamenridercraft:allrise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s[tag=allrise] krc.seq1 matches 12 run tag @s remove allrise
execute if score @s krc.seq1 matches 29 run playsound kamenridercraft:shotriser_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s[tag=warning] krc.seq1 matches 29 run playsound kamenridercraft:serval_tiger_warning player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s[tag=warning] krc.seq1 matches 63 run playsound kamenridercraft:serval_tiger_warning player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
