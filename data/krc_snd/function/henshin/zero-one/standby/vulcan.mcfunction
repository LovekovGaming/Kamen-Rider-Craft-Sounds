...
execute if score @s[tag=authorise] krc.seq1 matches 12 run playsound kamenridercraft:progrisekey_authorise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=overrise] krc.seq1 matches 12 run playsound kamenridercraft:overrise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=allrise] krc.seq1 matches 12 run playsound kamenridercraft:allrise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
