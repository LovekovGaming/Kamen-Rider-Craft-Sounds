...
execute if score @s[tag=authorise] krc.seq1 matches 15 run playsound kamenridercraft:progrisekey_authorise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=overrise] krc.seq1 matches 15 run playsound kamenridercraft:overrise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=burnrise] krc.seq1 matches 15 run playsound kamenridercraft:burnrise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=authorise_thouser] krc.seq1 matches 15 run playsound kamenridercraft:thouser_authorise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
