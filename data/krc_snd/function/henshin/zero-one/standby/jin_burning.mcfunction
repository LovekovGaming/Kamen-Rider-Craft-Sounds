...
execute if score @s krc.seq1 matches 10 run playsound kamenridercraft:burnrise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 32 run playsound kamenridercraft:slashriser_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
