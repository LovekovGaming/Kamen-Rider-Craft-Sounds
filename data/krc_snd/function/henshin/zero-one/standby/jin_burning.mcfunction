...
execute if score @s krc.seq1 matches 10 run function krc_snd:play_global {name:"kamenridercraft:burnrise",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 32 run function krc_snd:play_global {name:"kamenridercraft:slashriser_standby",scope:"henshin_snd"}
