...
execute if score @s krc.seq1 matches 10 run playsound kamenridercraft:progrisekey_authorise player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 27 run playsound kamenridercraft:slashabaddoriser_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
