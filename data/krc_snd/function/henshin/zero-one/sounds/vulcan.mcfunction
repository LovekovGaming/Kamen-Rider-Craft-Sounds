...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 92 run function krc_snd:play_global {name:"kamenridercraft:shooting_wolf_short",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 1 if score @s krc.seq1 matches 92 run function krc_snd:play_global {name:"kamenridercraft:punching_kong_short",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 2 if score @s krc.seq1 matches 92 run function krc_snd:play_global {name:"kamenridercraft:rising_hopper_short",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 3 if score @s krc.seq1 matches 92 run function krc_snd:play_global {name:"kamenridercraft:assault_wolf",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 5 if score @s krc.seq1 matches 92 run function krc_snd:play_global {name:"kamenridercraft:orthros_vulcan",scope:"henshin_snd"}
