...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 92 run playsound kamenridercraft:shooting_wolf_short player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 1 if score @s krc.seq1 matches 92 run playsound kamenridercraft:punching_kong_short player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 2 if score @s krc.seq1 matches 92 run playsound kamenridercraft:rising_hopper_short player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 3 if score @s krc.seq1 matches 92 run playsound kamenridercraft:assault_wolf player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 5 if score @s krc.seq1 matches 92 run playsound kamenridercraft:orthros_vulcan player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
