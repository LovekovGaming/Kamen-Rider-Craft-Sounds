...
execute if items entity @s armor.feet kamenridercraft:raidriser_battle if score @s krc.seq1 matches 42 run function krc_snd:play_global {name:"kamenridercraft:invading_horseshoe_crab_short",scope:"henshin_snd"}
...
execute if items entity @s armor.feet kamenridercraft:raidriser_buffalo if score @s krc.seq1 matches 42 run function krc_snd:play_global {name:"kamenridercraft:crushing_buffalo_short",scope:"henshin_snd"}
...
execute if items entity @s armor.feet kamenridercraft:raidriser_whale if score @s krc.seq1 matches 42 run function krc_snd:play_global {name:"kamenridercraft:splashing_whale_short",scope:"henshin_snd"}
...
execute if items entity @s armor.feet kamenridercraft:raidriser_lion if score @s krc.seq1 matches 42 run function krc_snd:play_global {name:"kamenridercraft:dynamaiting_lion_short",scope:"henshin_snd"}
...
execute if items entity @s armor.feet kamenridercraft:raidriser_penguin if score @s krc.seq1 matches 42 run function krc_snd:play_global {name:"kamenridercraft:storming_penguin_short",scope:"henshin_snd"}
...
execute if items entity @s armor.feet kamenridercraft:raidriser_panda if score @s krc.seq1 matches 42 run function krc_snd:play_global {name:"kamenridercraft:scouting_panda_short",scope:"henshin_snd"}
...
execute if items entity @s armor.feet kamenridercraft:raidriser_jackal if score @s krc.seq1 matches 42 run function krc_snd:play_global {name:"kamenridercraft:fighting_jackal_short",scope:"henshin_snd"}
