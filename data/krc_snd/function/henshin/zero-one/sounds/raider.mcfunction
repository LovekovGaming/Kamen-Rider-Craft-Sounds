...
execute if items entity @s armor.feet kamenridercraft:raidriser_battle if score @s krc.seq1 matches 42 run playsound kamenridercraft:invading_horseshoe_crab_short player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if items entity @s armor.feet kamenridercraft:raidriser_buffalo if score @s krc.seq1 matches 42 run playsound kamenridercraft:crushing_buffalo_short player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if items entity @s armor.feet kamenridercraft:raidriser_whale if score @s krc.seq1 matches 42 run playsound kamenridercraft:splashing_whale_short player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if items entity @s armor.feet kamenridercraft:raidriser_lion if score @s krc.seq1 matches 42 run playsound kamenridercraft:dynamaiting_lion_short player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if items entity @s armor.feet kamenridercraft:raidriser_penguin if score @s krc.seq1 matches 42 run playsound kamenridercraft:storming_penguin_short player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if items entity @s armor.feet kamenridercraft:raidriser_panda if score @s krc.seq1 matches 42 run playsound kamenridercraft:scouting_panda_short player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if items entity @s armor.feet kamenridercraft:raidriser_jackal if score @s krc.seq1 matches 42 run playsound kamenridercraft:fighting_jackal_short player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
