...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 92 run function krc_snd:play_global {name:"kamenridercraft:rushing_cheetah_short",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 1 if score @s krc.seq1 matches 92 run function krc_snd:play_global {name:"kamenridercraft:lightning_hornet_short",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 2 if score @s krc.seq1 matches 92 run function krc_snd:play_global {name:"kamenridercraft:serval_tiger",scope:"henshin_snd"}
