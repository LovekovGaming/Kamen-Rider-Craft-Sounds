...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 92 run playsound kamenridercraft:rushing_cheetah_short player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 1 if score @s krc.seq1 matches 92 run playsound kamenridercraft:lightning_hornet_short player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 2 if score @s krc.seq1 matches 92 run playsound kamenridercraft:serval_tiger player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
