...
execute if score @s krc.form1n matches 2..3 if score @s krc.seq1 matches 62 run playsound kamenridercraft:ark-one_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
