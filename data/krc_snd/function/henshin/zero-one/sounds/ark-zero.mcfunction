...
execute if score @s krc.form1n matches 2..3 if score @s krc.seq1 matches 62 run function krc_snd:play_global {name:"kamenridercraft:ark-one_henshin",scope:"henshin_snd"}
