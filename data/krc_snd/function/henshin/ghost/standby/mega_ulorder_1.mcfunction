...
execute if score @s krc.seq1 matches 29 run playsound kamenridercraft:mega_ulorder_yessir player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 54 run playsound kamenridercraft:mega_ulorder_standby_1 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
