...
execute if score @s krc.seq1 matches 27 run playsound kamenridercraft:ghost_driver_standby_gekikou_specter player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
