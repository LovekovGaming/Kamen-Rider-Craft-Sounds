...
advancement grant @s only krc_snd:henshin/ghost/kanon_specter_seq 1
...
playsound kamenridercraft:ghost_driver_push player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
