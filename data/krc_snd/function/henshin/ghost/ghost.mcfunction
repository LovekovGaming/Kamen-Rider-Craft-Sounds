...
execute if score @s krc.form1n matches 0 unless entity @s[tag=tousan_eyecon] run playsound kamenridercraft:ghost_driver_push player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s[tag=tousan_eyecon] krc.form1n matches 0 run playsound kamenridercraft:thank_you_tousan player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s[tag=tousan_eyecon] krc.form1n matches 0 run scoreboard players set @s krc.seq1 76
execute if score @s krc.form1n matches 1.. run playsound kamenridercraft:ghost_driver_push player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
