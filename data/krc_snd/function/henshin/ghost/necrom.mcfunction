...
execute if score @s krc.form1n matches 0 run playsound kamenridercraft:mega_ulorder_eyedrop player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 1 if score @s krc.form2n matches 0 run playsound kamenridercraft:yujou_burst_eyecon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 1 if score @s krc.form2n matches 1.. run playsound kamenridercraft:mega_ulorder_eyedrop player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
