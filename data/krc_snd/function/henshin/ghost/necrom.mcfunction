...
execute if score @s krc.form1n matches 0 run function krc_snd:play_global {name:"kamenridercraft:mega_ulorder_eyedrop",scope:"henshin_snd"}
execute if score @s krc.form1n matches 1 if score @s krc.form2n matches 0 run function krc_snd:play_global {name:"kamenridercraft:yujou_burst_eyecon",scope:"henshin_snd"}
execute if score @s krc.form1n matches 1 if score @s krc.form2n matches 1.. run function krc_snd:play_global {name:"kamenridercraft:mega_ulorder_eyedrop",scope:"henshin_snd"}
