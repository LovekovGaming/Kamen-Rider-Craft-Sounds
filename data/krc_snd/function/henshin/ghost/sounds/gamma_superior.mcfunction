...
execute if score @s krc.seq1 matches 48 if score @s krc.form2n matches 1.. run function krc_snd:play_global {name:"kamenridercraft:proto_ulorder",scope:"henshin_snd"}
