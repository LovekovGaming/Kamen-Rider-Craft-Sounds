...
execute if score @s krc.seq1 matches 48 if score @s krc.form2n matches 1.. run playsound kamenridercraft:proto_ulorder player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
