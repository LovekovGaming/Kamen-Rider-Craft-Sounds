...
execute if score @s[advancements={krc_snd:flags/agito/temporary={g7_short=false}}] krc.seq1 matches 7 run function krc_snd:play_global {name:"kamenridercraft:g7_activating",scope:"henshin_snd"}
execute if score @s[advancements={krc_snd:flags/agito/temporary={g7_short=true}}] krc.seq1 matches 7 run function krc_snd:play_global {name:"kamenridercraft:g7_activating_short",scope:"henshin_snd"}
