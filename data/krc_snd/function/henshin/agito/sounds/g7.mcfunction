...
execute if score @s[advancements={krc_snd:flags/agito/temporary={g7_short=false}}] krc.seq1 matches 7 run playsound kamenridercraft:g7_activating player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[advancements={krc_snd:flags/agito/temporary={g7_short=true}}] krc.seq1 matches 7 run playsound kamenridercraft:g7_activating_short player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
