...
execute if score @s krc.form1n matches 0 if score Form_Difference krc.form1n matches ..0 run playsound kamenridercraft:dark_kabuto_zecter_set player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 0 if score Form_Difference krc.form1n matches 1..2 run playsound kamenridercraft:dark_kabuto_put_on player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 1.. if entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:dark_kabuto_zecter_set player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!hyper_zecter_active] krc.form1n matches 3 run playsound kamenridercraft:hyper_cast_off_start player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
