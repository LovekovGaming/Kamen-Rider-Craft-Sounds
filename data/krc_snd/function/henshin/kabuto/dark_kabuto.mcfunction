...
execute if score @s krc.form1n matches 0 if score Form_Difference krc.form1n matches ..0 run function krc_snd:play_global {name:"kamenridercraft:dark_kabuto_zecter_set",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 0 if score Form_Difference krc.form1n matches 1..2 run function krc_snd:play_global {name:"kamenridercraft:dark_kabuto_put_on",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 1.. if entity @s[advancements={krc_core:player_transformed=false}] run function krc_snd:play_global {name:"kamenridercraft:dark_kabuto_zecter_set",scope:"henshin_snd"}
...
execute if score @s[tag=!hyper_zecter_active] krc.form1n matches 3 run function krc_snd:play_global {name:"kamenridercraft:hyper_cast_off_start",scope:"henshin_snd"}
