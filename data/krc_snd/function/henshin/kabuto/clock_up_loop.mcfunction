...
execute if score @s[tag=!hyper_clock_up] krc.seq3 matches 4 run playsound kamenridercraft:clock_up_loop player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=hyper_clock_up,tag=!hyper_loop_2] krc.seq3 matches 4 run playsound kamenridercraft:hyper_clock_up_loop_1 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=hyper_clock_up,tag=hyper_loop_2] krc.seq3 matches 4 run playsound kamenridercraft:hyper_clock_up_loop_2 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
