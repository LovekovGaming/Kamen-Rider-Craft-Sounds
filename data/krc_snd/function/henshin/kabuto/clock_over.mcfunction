execute if entity @s[tag=!hyper_clock_up] unless items entity @s armor.feet kamenridercraft:gatack_rider_belt run playsound kamenridercraft:clock_over player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if entity @s[tag=!hyper_clock_up] if items entity @s armor.feet kamenridercraft:gatack_rider_belt run playsound kamenridercraft:gatack_clock_over player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=hyper_clock_up] run playsound kamenridercraft:hyper_clock_over player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
