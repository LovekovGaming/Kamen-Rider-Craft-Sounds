execute if entity @s[tag=!hyper_clock_up] unless items entity @s armor.feet kamenridercraft:gatack_rider_belt run function krc_snd:play_global {name:"kamenridercraft:clock_over",scope:"henshin_snd"}
execute if entity @s[tag=!hyper_clock_up] if items entity @s armor.feet kamenridercraft:gatack_rider_belt run function krc_snd:play_global {name:"kamenridercraft:gatack_clock_over",scope:"henshin_snd"}
...
execute if entity @s[tag=hyper_clock_up] run function krc_snd:play_global {name:"kamenridercraft:hyper_clock_over",scope:"henshin_snd"}
