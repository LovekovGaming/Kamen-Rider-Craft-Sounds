...
execute if score @s[advancements={krc_core:player_transformed=false}] krc.form1n matches 1 run playsound kamenridercraft:kabutick_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
