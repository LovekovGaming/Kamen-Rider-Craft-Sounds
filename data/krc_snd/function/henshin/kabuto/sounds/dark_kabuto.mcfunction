...
execute if score @s krc.seq1 matches 56 if score @s krc.form1n matches 0 run playsound kamenridercraft:dark_kabuto_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 56 if score @s krc.form1n matches 0 run scoreboard players set @s krc.seq1 163
execute if score @s krc.seq1 matches 7 if score @s krc.form1n matches 1..2 run playsound kamenridercraft:cast_off player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 63 if score @s krc.form1n matches 1..2 run playsound kamenridercraft:dark_kabuto_cast_off player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 135 if score @s krc.form1n matches 1..2 run playsound kamenridercraft:change_beetle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 143 if score @s krc.form1n matches 3 run playsound kamenridercraft:change_hyper_beetle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
