...
execute if score @s krc.seq1 matches 56 if score @s krc.form1n matches 0 run function krc_snd:play_global {name:"kamenridercraft:dark_kabuto_henshin",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 63 if score @s krc.form1n matches 1..2 run function krc_snd:play_global {name:"kamenridercraft:dark_kabuto_cast_off",scope:"henshin_snd"}
