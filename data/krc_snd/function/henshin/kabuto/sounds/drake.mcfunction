...
execute if score @s krc.seq1 matches 63 if score @s krc.form1n matches 1 run playsound kamenridercraft:rider_brace_cast_off player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 164 if score @s krc.form1n matches 1 run playsound kamenridercraft:change_dragonfly player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
