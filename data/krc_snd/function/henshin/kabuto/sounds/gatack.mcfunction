...
execute if score @s krc.seq1 matches 56 if score @s krc.form1n matches 0 run playsound kamenridercraft:gatack_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 56 if score @s krc.form1n matches 0 run scoreboard players set @s krc.seq1 163
execute if score @s krc.seq1 matches 7 if score @s krc.form1n matches 1..2 run playsound kamenridercraft:gatack_zecter_cast_off player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 67 if score @s krc.form1n matches 1..2 run playsound kamenridercraft:gatack_cast_off player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 161 if score @s krc.form1n matches 1..2 run playsound kamenridercraft:change_stag_beetle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 63 if score @s krc.form1n matches 3 run playsound kamenridercraft:kabuto_hyper_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 143 if score @s krc.form1n matches 3 run playsound kamenridercraft:change_hyper_stag_beetle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
