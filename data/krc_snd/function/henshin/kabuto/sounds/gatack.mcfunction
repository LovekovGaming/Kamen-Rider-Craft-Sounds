...
execute if score @s krc.seq1 matches 56 if score @s krc.form1n matches 0 run function krc_snd:play_global {name:"kamenridercraft:gatack_henshin",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 56 if score @s krc.form1n matches 0 run scoreboard players set @s krc.seq1 163
execute if score @s krc.seq1 matches 7 if score @s krc.form1n matches 1..2 run function krc_snd:play_global {name:"kamenridercraft:gatack_zecter_cast_off",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 67 if score @s krc.form1n matches 1..2 run function krc_snd:play_global {name:"kamenridercraft:gatack_cast_off",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 161 if score @s krc.form1n matches 1..2 run function krc_snd:play_global {name:"kamenridercraft:change_stag_beetle",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 143 if score @s krc.form1n matches 3 run function krc_snd:play_global {name:"kamenridercraft:change_hyper_stag_beetle",scope:"henshin_snd"}
