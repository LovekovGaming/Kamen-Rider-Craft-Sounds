...
execute if score @s krc.seq1 matches 164 if score @s krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:change_scorpion",scope:"henshin_snd"}
