...
execute if score @s krc.seq1 matches 63 if score @s krc.form1n matches 1..2 run playsound kamenridercraft:kabuto_cast_off player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
