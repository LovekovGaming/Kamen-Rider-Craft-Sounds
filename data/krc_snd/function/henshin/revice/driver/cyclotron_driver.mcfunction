...
execute unless items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:cyclotron_driver_core_break"}] run function krc_snd:play_global {name:"kamenridercraft:cyclotron_driver_name",scope:"equip_snd"}
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:cyclotron_driver_core_break"}] run function krc_snd:play_global {name:"kamenridercraft:cyclotron_driver_name_break",scope:"equip_snd"}
