...
execute unless items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:cyclotron_driver_core_break"}] run playsound kamenridercraft:cyclotron_driver_name player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~ 3
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:cyclotron_driver_core_break"}] run playsound kamenridercraft:cyclotron_driver_name_break player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~ 3
