...
execute if score @s krc.form1n matches 0..17 run playsound kamenridercraft:buddy_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 18 run playsound kamenridercraft:baribari_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 19 run playsound kamenridercraft:burst_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 20 run playsound kamenridercraft:jack_revice player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 21 run playsound kamenridercraft:thunder_gale player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 22 run playsound kamenridercraft:ultimate_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 23 run playsound kamenridercraft:tornado_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 24 run playsound kamenridercraft:gold_spino_genome player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 25 run playsound kamenridercraft:synchro_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
