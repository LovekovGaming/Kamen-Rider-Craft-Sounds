...
execute if score @s krc.seq1 matches 20 run playsound kamenridercraft:juuga_animals player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 250 run playsound kamenridercraft:juuga_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
