...
execute if score @s krc.seq1 matches 20 run function krc_snd:play_global {name:"kamenridercraft:juuga_animals",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 250 run function krc_snd:play_global {name:"kamenridercraft:juuga_standby",scope:"henshin_snd"}
