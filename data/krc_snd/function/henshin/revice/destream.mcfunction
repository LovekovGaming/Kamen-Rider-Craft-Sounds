...
execute if entity @s[advancements={krc_core:player_transformed=false}] if score @s krc.configs.destream_voice matches 0 run function krc_snd:play_global {name:"kamenridercraft:spirit_up",scope:"henshin_snd"}
execute if entity @s[advancements={krc_core:player_transformed=false}] if score @s krc.configs.destream_voice matches 1 run function krc_snd:play_global {name:"kamenridercraft:spirit_up_alt",scope:"henshin_snd"}
...
execute unless entity @s[advancements={krc_core:player_transformed=false}] if score @s krc.form1n matches 0 run function krc_snd:play_global {name:"kamenridercraft:revice_detransform",scope:"henshin_snd"}
execute unless entity @s[advancements={krc_core:player_transformed=false}] if score @s krc.form1n matches 1.. run function krc_snd:play_global {name:"kamenridercraft:vistamp_down",scope:"henshin_snd"}
execute unless entity @s[advancements={krc_core:player_transformed=false}] if score @s krc.form1n matches 1.. run function krc_snd:play_global {name:"kamenridercraft:dominate_up_destream",scope:"henshin_snd"}
