...
execute if entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:vistamp_down player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if entity @s[advancements={krc_core:player_transformed=false}] if score @s krc.configs.destream_voice matches 0 run playsound kamenridercraft:spirit_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if entity @s[advancements={krc_core:player_transformed=false}] if score @s krc.configs.destream_voice matches 1 run playsound kamenridercraft:spirit_up_alt player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless entity @s[advancements={krc_core:player_transformed=false}] if score @s krc.form1n matches 0 run playsound kamenridercraft:revice_detransform player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute unless entity @s[advancements={krc_core:player_transformed=false}] if score @s krc.form1n matches 1.. run playsound kamenridercraft:vistamp_down player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute unless entity @s[advancements={krc_core:player_transformed=false}] if score @s krc.form1n matches 1.. run playsound kamenridercraft:dominate_up_destream player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
