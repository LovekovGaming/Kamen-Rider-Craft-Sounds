...
advancement grant @s only krc_snd:henshin/revice/demons_trooper_a_seq 1
...
playsound kamenridercraft:demons_trooper player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
