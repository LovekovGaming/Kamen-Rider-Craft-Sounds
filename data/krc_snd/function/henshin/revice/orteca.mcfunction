...
advancement grant @s only krc_snd:henshin/revice/orteca_seq 1
...
playsound kamenridercraft:vistamp_down_kraken player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
playsound kamenridercraft:demons_trooper player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.revice.decide_up","color":"green"}
