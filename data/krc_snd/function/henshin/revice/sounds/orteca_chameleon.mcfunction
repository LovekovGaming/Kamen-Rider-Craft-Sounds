...
execute if score @s krc.seq1 matches 45 run playsound kamenridercraft:chameleon_name player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
playsound kamenridercraft:genomix player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
