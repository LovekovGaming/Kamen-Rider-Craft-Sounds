...
execute if score @s krc.seq1 matches 126 if score @s krc.form1n matches 0 run playsound kamenridercraft:bat_name player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 1 run playsound kamenridercraft:jackal_name player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
