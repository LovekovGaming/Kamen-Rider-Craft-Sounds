...
execute if score @s[tag=destream_henshin] krc.seq1 matches 48 if score @s krc.form1n matches 0 run function krc_snd:play_global {name:"kamenridercraft:destream_henshin",scope:"henshin_snd"}
execute if score @s[tag=destream_henshin] krc.seq1 matches 48 if score @s krc.form1n matches 1..2 run function krc_snd:play_global {name:"kamenridercraft:destream_henshin_neo_burst",scope:"henshin_snd"}
execute if score @s[tag=destream_henshin] krc.seq1 matches 48 if score @s krc.form1n matches 3 run function krc_snd:play_global {name:"kamenridercraft:destream_henshin_kong",scope:"henshin_snd"}
...
execute if score @s[tag=!destream_henshin] krc.seq1 matches 47 if score @s krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:crocodile_name",scope:"henshin_snd"}
...
execute if score @s[tag=!destream_henshin] krc.seq1 matches 47 if score @s krc.form1n matches 2 run function krc_snd:play_global {name:"kamenridercraft:komodo_dragon_name",scope:"henshin_snd"}
...
execute if score @s[tag=!destream_henshin] krc.seq1 matches 47 if score @s krc.form1n matches 3 run function krc_snd:play_global {name:"kamenridercraft:kong_name",scope:"henshin_snd"}
...
execute if score @s[tag=!destream_henshin] krc.seq1 matches 74 if score @s krc.form1n matches 1.. if score @s krc.configs.destream_voice matches 0 run function krc_snd:play_global {name:"kamenridercraft:neo_burst",scope:"henshin_snd"}
execute if score @s[tag=!destream_henshin] krc.seq1 matches 74 if score @s krc.form1n matches 1.. if score @s krc.configs.destream_voice matches 1 run function krc_snd:play_global {name:"kamenridercraft:neo_burst_alt",scope:"henshin_snd"}
