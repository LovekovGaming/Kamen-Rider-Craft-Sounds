...
execute if score @s[tag=destream_henshin] krc.seq1 matches 48 if score @s krc.form1n matches 0 run playsound kamenridercraft:destream_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=destream_henshin] krc.seq1 matches 48 if score @s krc.form1n matches 1..2 run playsound kamenridercraft:destream_henshin_neo_burst player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=destream_henshin] krc.seq1 matches 48 if score @s krc.form1n matches 3 run playsound kamenridercraft:destream_henshin_kong player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!destream_henshin] krc.seq1 matches 47 if score @s krc.form1n matches 1 run playsound kamenridercraft:crocodile_name player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!destream_henshin] krc.seq1 matches 47 if score @s krc.form1n matches 2 run playsound kamenridercraft:komodo_dragon_name player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!destream_henshin] krc.seq1 matches 47 if score @s krc.form1n matches 3 run playsound kamenridercraft:kong_name player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!destream_henshin] krc.seq1 matches 74 if score @s krc.form1n matches 1.. if score @s krc.configs.destream_voice matches 0 run playsound kamenridercraft:neo_burst player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=!destream_henshin] krc.seq1 matches 74 if score @s krc.form1n matches 1.. if score @s krc.configs.destream_voice matches 1 run playsound kamenridercraft:neo_burst_alt player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
