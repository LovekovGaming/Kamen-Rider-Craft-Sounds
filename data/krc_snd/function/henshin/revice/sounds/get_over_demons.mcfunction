...
execute if score @s[tag=demons_henshin] krc.seq1 matches 160 if score @s krc.form2n matches 0 if score @s krc.form3n matches 0 if score @s krc.form4n matches 0 if score @s krc.form5n matches 0 run playsound kamenridercraft:get_over_demons player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=!demons_henshin] krc.seq1 matches 45 if score @s krc.form2n matches 1 run playsound kamenridercraft:mogura_name player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=!demons_henshin] krc.seq1 matches 45 if score @s krc.form2n matches 2 run playsound kamenridercraft:anomalocaris_name player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=!demons_henshin] krc.seq1 matches 90 if score @s krc.form3n matches 1 run playsound kamenridercraft:condor_name player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=!demons_henshin] krc.seq1 matches 135 if score @s krc.form5n matches 1 run playsound kamenridercraft:scorpion_name player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=!demons_henshin] krc.seq1 matches 180 if score @s krc.form5n matches 1 run playsound kamenridercraft:batta_name player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=!demons_henshin] run playsound kamenridercraft:genomix player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
