...
execute if score @s[tag=demons_henshin] krc.seq1 matches 160 if score @s krc.form2n matches 0 if score @s krc.form3n matches 0 if score @s krc.form4n matches 0 if score @s krc.form5n matches 0 run function krc_snd:play_global {name:"kamenridercraft:get_over_demons",scope:"henshin_snd"}
