...
execute if score @s krc.form1n matches 0..20 unless score @s krc.form1n matches 16..19 run playsound kamenridercraft:buddy_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 16 run playsound kamenridercraft:baribari_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 17 run playsound kamenridercraft:burst_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 18 run playsound kamenridercraft:ultimate_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 19 run playsound kamenridercraft:gold_spino_genome player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
