...
execute if score @s krc.seq1 matches 33 run function krc_snd:play_global {name:"kamenridercraft:fourze_countdown",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 97 run function krc_snd:play_global {name:"kamenridercraft:fourze_standby",scope:"henshin_snd"}
