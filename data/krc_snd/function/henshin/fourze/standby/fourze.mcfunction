...
execute if score @s krc.seq1 matches 33 run playsound kamenridercraft:fourze_countdown player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 97 run playsound kamenridercraft:fourze_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
