...
execute if score @s krc.form4n matches 9 if score @s krc.seq1 matches 11 run function krc_snd:play_global {name:"kamenridercraft:s_magnet_switch_on",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 8 unless score @s krc.form4n matches 9 if score @s krc.seq1 matches 83 run function krc_snd:play_global {name:"kamenridercraft:magnet_module",scope:"henshin_snd"}
execute unless score @s krc.form1n matches 8 if score @s krc.form4n matches 9 if score @s krc.seq1 matches 83 run function krc_snd:play_global {name:"kamenridercraft:magnet_module",scope:"henshin_snd"}
execute if score @s krc.form1n matches 8 if score @s krc.form4n matches 9 if score @s krc.seq1 matches 83 run function krc_snd:play_global {name:"kamenridercraft:magnetstates",scope:"henshin_snd"}
