...
execute if score @s krc.form4n matches 9 if score @s krc.seq1 matches 11 run playsound kamenridercraft:s_magnet_switch_on player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 8 unless score @s krc.form4n matches 9 if score @s krc.seq1 matches 83 run playsound kamenridercraft:magnet_module player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute unless score @s krc.form1n matches 8 if score @s krc.form4n matches 9 if score @s krc.seq1 matches 83 run playsound kamenridercraft:magnet_module player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 8 if score @s krc.form4n matches 9 if score @s krc.seq1 matches 83 run playsound kamenridercraft:magnetstates player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
