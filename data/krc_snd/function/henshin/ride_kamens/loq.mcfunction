...
execute if score @s krc.form1n matches 0 unless score @s krc.configs.ride_kamens matches 1 run playsound kamenridercraft:loq_lance player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 1 unless score @s krc.configs.ride_kamens matches 1 run playsound kamenridercraft:loq_q player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
