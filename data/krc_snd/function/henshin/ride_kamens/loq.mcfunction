...
execute if score @s krc.form1n matches 0 unless score @s krc.configs.ride_kamens matches 1 run function krc_snd:play_global {name:"kamenridercraft:loq_lance",scope:"henshin_snd"}
