...
execute if score @s krc.seq1 matches 6 run function krc_snd:play_global {name:"kamenridercraft:cyclone_memory",scope:"henshin_snd"}
...
function krc_snd:play_global {name:"kamenridercraft:cyclone_active",scope:"henshin_snd"}
