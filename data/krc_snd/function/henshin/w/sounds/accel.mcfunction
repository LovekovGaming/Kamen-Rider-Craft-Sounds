...
execute if score @s krc.seq1 matches 10 if score @s krc.form1n matches 0 run playsound kamenridercraft:accel_memory player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 10 if score @s krc.form1n matches 2 run playsound kamenridercraft:trial_memory player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 22 if score @s krc.form1n matches 0 run playsound kamenridercraft:accel_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
