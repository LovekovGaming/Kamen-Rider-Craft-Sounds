...
execute if score @s krc.seq1 matches 6 run playsound kamenridercraft:joker_memory player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
playsound kamenridercraft:joker_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
