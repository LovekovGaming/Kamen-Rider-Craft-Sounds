...
execute unless score @s[tag=!shippu_in,tag=!kirifuda_in] krc.form1n matches 6 run playsound kamenridercraft:doubledriver_open player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute unless score @s[tag=shippu_in] krc.form1n matches 6 run playsound kamenridercraft:doubledriver_open_jidaigeki player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute unless score @s[tag=!shippu_in,tag=kirifuda_in] krc.form1n matches 6 run playsound kamenridercraft:doubledriver_open_jidaigeki player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 6 run playsound kamenridercraft:gold_xtreme player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 6 unless score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:doubledriver_open player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
