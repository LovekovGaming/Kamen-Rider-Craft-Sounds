...
execute if score @s[tag=sword_vent] krc.configs.ryuki_type matches 0 run playsound kamenridercraft:alt_sword_vent player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s[tag=sword_vent] krc.configs.ryuki_type matches 1 run playsound kamenridercraft:sword_vent_dragon_knight player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=accele_vent] krc.configs.ryuki_type matches 0 run playsound kamenridercraft:accele_vent player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s[tag=accele_vent] krc.configs.ryuki_type matches 1 run playsound kamenridercraft:speed_vent player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
