...
execute if score @s krc.configs.ryuki_type matches 0 unless score @s[tag=survive] krc.form1n matches 3 run function krc_snd:play_global {name:"kamenridercraft:survive",scope:"henshin_snd"}
execute if score @s krc.configs.ryuki_type matches 0 if score @s[tag=survive] krc.form1n matches 3 run function krc_snd:play_global {name:"kamenridercraft:ouja_survive",scope:"henshin_snd"}
...
execute if score @s krc.configs.ryuki_type matches 1 run function krc_snd:play_global {name:"kamenridercraft:wing_knight_survive_mode",scope:"henshin_snd"}
