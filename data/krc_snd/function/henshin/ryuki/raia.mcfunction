...
execute if score @s[advancements={krc_core:player_transformed=true}] krc.form1n matches 1 if score @s krc.configs.ryuki_type matches 0 run playsound kamenridercraft:visor_open player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s[advancements={krc_core:player_transformed=true}] krc.form1n matches 1 if score @s krc.configs.ryuki_type matches 1 run playsound kamenridercraft:visor_close_dragon_knight player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
