...
execute if score @s[tag=no_standby] krc.seq1 matches 10 run playsound kamenridercraft:birth_medal_ready player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 15 run playsound kamenridercraft:birth_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
