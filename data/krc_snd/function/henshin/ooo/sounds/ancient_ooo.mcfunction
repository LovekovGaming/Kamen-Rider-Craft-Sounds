...
execute if score @s krc.seq1 matches 38 run playsound kamenridercraft:ancient_taka_medal player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 50 run playsound kamenridercraft:ancient_tora_medal player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 62 run playsound kamenridercraft:ancient_batta_medal player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~

execute if score @s krc.seq1 matches ..79 run return 0
playsound kamenridercraft:ancient_ooo player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
