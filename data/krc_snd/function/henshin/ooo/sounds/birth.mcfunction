...
execute if score @s[tag=!birth_claws] krc.seq1 matches 13 run playsound kamenridercraft:birth_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s[tag=!birth_claws] krc.seq1 matches 13 run scoreboard players set @s krc.seq1 75
execute if score @s[tag=birth_claws] krc.seq1 matches 13 run playsound kamenridercraft:birth_claws player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=breast_cannon] krc.seq1 matches 75 run playsound kamenridercraft:breast_cannon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=crane_arm] krc.seq1 matches 115 run playsound kamenridercraft:crane_arm player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=drill_arm] krc.seq1 matches 155 run playsound kamenridercraft:drill_arm player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=caterpillar_leg] krc.seq1 matches 195 run playsound kamenridercraft:caterpillar_leg player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=shovel_arm] krc.seq1 matches 235 run playsound kamenridercraft:shovel_arm player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=cutter_wing] krc.seq1 matches 275 run playsound kamenridercraft:cutter_wing player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
