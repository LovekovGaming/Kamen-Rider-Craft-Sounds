...
execute if score @s krc.seq1 matches 38 run playsound kamenridercraft:mukade_medal player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 50 run playsound kamenridercraft:hachi_medal player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 62 run playsound kamenridercraft:ari_medal player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3

execute if score @s krc.seq1 matches ..79 run return 0
playsound kamenridercraft:goda_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
