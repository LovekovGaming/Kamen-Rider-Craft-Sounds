...
execute unless score @s krc.form1n matches 16 unless score @s krc.form2n matches 18 unless score @s krc.form3n matches 16 run function krc_snd:play_global {name:"kamenridercraft:medal_scan",scope:"henshin_snd"}
execute if score @s krc.form1n matches 16 run function krc_snd:play_global {name:"kamenridercraft:medal_scan_love",scope:"henshin_snd"}
execute unless score @s krc.form1n matches 16 if score @s krc.form2n matches 18 run function krc_snd:play_global {name:"kamenridercraft:medal_scan_love",scope:"henshin_snd"}
