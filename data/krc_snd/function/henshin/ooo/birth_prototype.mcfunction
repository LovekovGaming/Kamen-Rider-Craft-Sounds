...
execute unless score Form_Difference krc.form2n matches 1 unless score Form_Difference krc.form3n matches 1 unless score Form_Difference krc.form4n matches 1 run function krc_snd:play_global {name:"kamenridercraft:birth_knob_turn",scope:"henshin_snd"}
