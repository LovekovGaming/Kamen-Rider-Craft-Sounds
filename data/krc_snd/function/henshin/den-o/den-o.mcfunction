...
execute if score @s krc.form1n matches 1 run playsound kamenridercraft:rod_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 2 run playsound kamenridercraft:ax_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 3 run playsound kamenridercraft:gun_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 4 run playsound kamenridercraft:wing_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 5 unless score Form_Difference krc.form1n matches 1..3 run playsound kamenridercraft:climax_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 6 unless score Form_Difference krc.form1n matches -1..2 run playsound kamenridercraft:climax_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 7 unless score Form_Difference krc.form1n matches -2..1 run playsound kamenridercraft:climax_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 8 unless score Form_Difference krc.form1n matches -4..-1 run playsound kamenridercraft:climax_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 8 if score Form_Difference krc.form1n matches -4 run playsound kamenridercraft:super_climax_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 9 run playsound kamenridercraft:liner_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 10 run playsound kamenridercraft:pudding_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
