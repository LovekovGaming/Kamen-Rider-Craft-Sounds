...
execute unless score @s krc.form1n matches 2 run playsound kamenridercraft:amazons_driver player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute unless score @s krc.form1n matches 2 run advancement grant @s only krc_snd:henshin/extras/amazon_alpha_seq 1
execute if score @s krc.form1n matches 2 run playsound kamenridercraft:amazon_alpha_origin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
