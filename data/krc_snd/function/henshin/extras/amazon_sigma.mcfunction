...
execute unless score @s krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:amazons_driver",scope:"henshin_snd"}
execute unless score @s krc.form1n matches 1 run advancement grant @s only krc_snd:henshin/extras/amazon_sigma_seq 1
execute if score @s krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:amazon_alpha_origin",scope:"henshin_snd"}
