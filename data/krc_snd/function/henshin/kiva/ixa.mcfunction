...
execute unless score Form_Difference krc.form1n matches -1 if score @s krc.form1n matches 0 run playsound kamenridercraft:fist_on_2008 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 1 run playsound kamenridercraft:ixa_burst_mode player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 2 run playsound kamenridercraft:rising_ixa player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
