...
execute if score @s krc.seq1 matches 10 if score @s krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:garulu_saber_kivat",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 20 if score @s krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:garulu_saber",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 10 if score @s krc.form1n matches 2 run function krc_snd:play_global {name:"kamenridercraft:basshaa_magnum_kivat",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 20 if score @s krc.form1n matches 2 run function krc_snd:play_global {name:"kamenridercraft:basshaa_magnum",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 10 if score @s krc.form1n matches 3 run function krc_snd:play_global {name:"kamenridercraft:dogga_hammer_kivat",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 20 if score @s krc.form1n matches 3 run function krc_snd:play_global {name:"kamenridercraft:dogga_hammer",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 70 if score @s krc.form1n matches 5..6 run function krc_snd:play_global {name:"kamenridercraft:kiva_emperor",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 70 if score @s krc.form1n matches 5..6 run scoreboard players set @s krc.seq1 132
execute if score @s krc.seq1 matches 20 if score @s krc.form1n matches 7 run function krc_snd:play_global {name:"kamenridercraft:dogabaki_emperor",scope:"henshin_snd"}
