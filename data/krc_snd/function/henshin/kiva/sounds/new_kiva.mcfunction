...
execute if score @s krc.seq1 matches 10 if score @s krc.form1n matches 1 run playsound kamenridercraft:garulu_saber_kivat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3.05
...
execute if score @s krc.seq1 matches 10 if score @s krc.form1n matches 2 run playsound kamenridercraft:basshaa_magnum_kivat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3.05
...
execute if score @s krc.seq1 matches 10 if score @s krc.form1n matches 3 run playsound kamenridercraft:dogga_hammer_kivat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3.05
