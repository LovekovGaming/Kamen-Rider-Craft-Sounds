advancement revoke @s only krc_snd:henshin/kiva/new_kiva_seq 2
scoreboard players add @s krc.seq1 1

execute if score @s krc.seq1 matches 10 if score @s krc.form1n matches 1 run playsound kamenridercraft:garulu_saber_kivat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 1.05
...
execute if score @s krc.seq1 matches 20 if score @s krc.form1n matches 1 run playsound kamenridercraft:garulu_saber player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 10 if score @s krc.form1n matches 2 run playsound kamenridercraft:basshaa_magnum_kivat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 1.05
...
execute if score @s krc.seq1 matches 20 if score @s krc.form1n matches 2 run playsound kamenridercraft:basshaa_magnum player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 10 if score @s krc.form1n matches 3 run playsound kamenridercraft:dogga_hammer_kivat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 1.05
...
execute if score @s krc.seq1 matches 20 if score @s krc.form1n matches 3 run playsound kamenridercraft:dogga_hammer player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 70 if score @s krc.form1n matches 5..6 run playsound kamenridercraft:kiva_emperor player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 70 if score @s krc.form1n matches 5..6 run scoreboard players set @s krc.seq1 132
execute if score @s krc.seq1 matches 20 if score @s krc.form1n matches 7 run playsound kamenridercraft:dogabaki_emperor player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
