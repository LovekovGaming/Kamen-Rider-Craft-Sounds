...
execute if score @s krc.form1n matches 0 run playsound kamenridercraft:kiva_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 1..3 unless entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:fuestle_lock player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 1..3 if entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:kiva_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 0.5
...
execute if score @s krc.form1n matches 4 unless entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:dogabaki player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 4 if entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:kiva_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 0.96
execute if score @s krc.form1n matches 5 unless entity @s[advancements={krc_core:player_transformed=false}] unless score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:tatsulot_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 6 unless entity @s[advancements={krc_core:player_transformed=false}] unless score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:tatsulot_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 7 unless entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:flight_style player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 8 unless entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:dogabaki_emperor player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 5..8 if entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:kiva_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
