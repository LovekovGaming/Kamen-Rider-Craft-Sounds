...
execute if score @s krc.seq1 matches 21 run playsound kamenridercraft:doron_doron player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 100 run playsound kamenridercraft:artificial_kivat_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
