...
tag @s add bokuni_tsurarete_miru
playsound kamenridercraft:decadriver player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
scoreboard players reset @s krc-atkride.den-o_r
advancement revoke @s only krc_snd:henshin/decade/attackride_card_detect_den-o_r