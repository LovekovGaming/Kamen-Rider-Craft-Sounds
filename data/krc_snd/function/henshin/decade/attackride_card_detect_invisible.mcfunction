...
tag @s add invisible
execute unless items entity @s armor.feet kamenridercraft:diend_belt run playsound kamenridercraft:decadriver player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if items entity @s armor.feet kamenridercraft:diend_belt run playsound kamenridercraft:diend_fire player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~