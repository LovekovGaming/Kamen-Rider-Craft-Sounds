...
execute if entity @s[tag=crossattack] if score @s krc.seq1 matches 10 run playsound kamenridercraft:diend_crossattack player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=barrier] if score @s krc.seq1 matches 10 run playsound kamenridercraft:diend_barrier player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
