...
execute if score @s krc.form1n matches 59 if score @s krc.seq1 matches 30 run function krc_snd:play_global {name:"kamenridercraft:decade_ooo_armor",scope:"henshin_snd"}
