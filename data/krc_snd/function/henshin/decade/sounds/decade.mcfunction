...
execute if score @s krc.form1n matches 59 if score @s krc.seq1 matches 30 run playsound kamenridercraft:decade_ooo_armor player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
