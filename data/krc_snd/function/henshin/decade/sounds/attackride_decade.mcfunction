...
execute if entity @s[tag=blast] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_blast player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=slash] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_slash player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=illusion] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_illusion player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=invisible] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_invisible player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=rekka_daizantou] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_rekka_daizantou player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=gigant] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_g4_gigant player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=strike_vent] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_ryuki_strike_vent player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=metal] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_blade_metal player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=mach] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_blade_mach player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=ongekibou_rekka] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_hibiki_ongekibou_rekka player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=onibi] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_hibiki_onibi player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=clock_up] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_kabuto_clock_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=ore_sanjou] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_den-o_ore_sanjou player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=bokuni_tsurarete_miru] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_den-o_bokuni_tsurarete_miru player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=nakerude] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_den-o_nakerude player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=kotaewa_kiite_nai] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_den-o_kotaewa_kiite_nai player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=tsuppari] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_den-o_tsuppari player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=utchari] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_den-o_utchari player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=gaga_no_udewa] if score @s krc.seq1 matches 10 run playsound kamenridercraft:decade_amazon_gaga_no_udewa player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
