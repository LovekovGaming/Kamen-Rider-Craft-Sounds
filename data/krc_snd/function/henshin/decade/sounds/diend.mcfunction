...
execute if score @s krc.form1n matches 0..2 if score @s krc.seq1 matches 17 run playsound kamenridercraft:callout_diend player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 0..2 if score @s krc.seq1 matches 39 run playsound kamenridercraft:diend_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 4 if score @s krc.seq1 matches 17 run playsound kamenridercraft:callout_chinomanako_diend player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 4 if score @s krc.seq1 matches 39 run playsound kamenridercraft:chinomanako_diend_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
