...
execute if score @s[tag=kamen_ride] krc.seq1 matches 10 run playsound kamenridercraft:kamen_ride player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=form_ride] krc.seq1 matches 10 run playsound kamenridercraft:form_ride player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=attack_ride] krc.seq1 matches 10 run playsound kamenridercraft:attack_ride player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=final_form_ride] krc.seq1 matches 10 run playsound kamenridercraft:final_form_ride player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=final_form_ride_chalice] krc.seq1 matches 10 run playsound kamenridercraft:final_form_ride_chalice player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 19 run playsound kamenridercraft:decadriver_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
