...
execute if score @s[tag=chinomanako_kamen_ride] krc.seq1 matches 7 run playsound kamenridercraft:chinomanako_kamen_ride player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 14 run playsound kamenridercraft:chinomanako_diend_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
