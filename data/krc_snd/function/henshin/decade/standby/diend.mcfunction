...
execute if score @s[tag=kamen_ride] krc.seq1 matches 7 run playsound kamenridercraft:kamen_ride player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=attack_ride] krc.seq1 matches 7 run playsound kamenridercraft:attack_ride player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 14 run playsound kamenridercraft:diend_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
