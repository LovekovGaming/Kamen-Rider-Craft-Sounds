...
tag @s add rekka_daizantou
playsound kamenridercraft:decadriver player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
scoreboard players reset @s krc-atkride.daizantou
advancement revoke @s only krc_snd:henshin/decade/attackride_card_detect_rekka_daizantou