...
execute if score @s[advancements={krc_snd:henshin/zeztz/capsems={agent=true}}] krc.seq1 matches 15 run playsound kamenridercraft:agent_capsem player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 40 run playsound kamenridercraft:zeztz_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
