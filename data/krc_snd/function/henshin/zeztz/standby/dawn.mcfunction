...
execute if score @s krc.seq1 matches 37 run playsound kamenridercraft:punish_capsem player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 61 run playsound kamenridercraft:dawn_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
