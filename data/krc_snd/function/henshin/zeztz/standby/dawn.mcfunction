...
execute if score @s krc.seq1 matches 37 run function krc_snd:play_global {name:"kamenridercraft:punish_capsem",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 61 run function krc_snd:play_global {name:"kamenridercraft:dawn_standby",scope:"henshin_snd"}
