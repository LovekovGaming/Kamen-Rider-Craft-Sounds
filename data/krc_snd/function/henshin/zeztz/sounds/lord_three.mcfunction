...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 53 run playsound kamenridercraft:lord_three player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 1 if score @s krc.seq1 matches 171 run playsound kamenridercraft:lord_thirteen player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 2 if score @s krc.seq1 matches 171 run playsound kamenridercraft:lord_three_booster player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 3 if score @s krc.seq1 matches 171 run playsound kamenridercraft:break_code_down player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
