...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 53 run playsound kamenridercraft:lord_six player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
