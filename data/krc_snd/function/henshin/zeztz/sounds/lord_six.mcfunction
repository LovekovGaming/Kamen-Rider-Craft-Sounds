...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 53 run function krc_snd:play_global {name:"kamenridercraft:lord_six",scope:"henshin_snd"}
