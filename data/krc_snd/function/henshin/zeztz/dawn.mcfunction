...
execute if score @s krc.form1n matches 0 run playsound kamenridercraft:breakam_dawn_separate player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 1 run playsound kamenridercraft:capsem_in_dawn player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
