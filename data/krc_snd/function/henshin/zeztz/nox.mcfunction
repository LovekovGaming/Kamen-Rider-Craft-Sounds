...
execute if score @s krc.form1n matches 3 unless items entity @s weapon.offhand kamenridercraft:midnightshadow run playsound kamenridercraft:nox_midnight_shadow player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 3 if items entity @s weapon.offhand kamenridercraft:midnightshadow run playsound kamenridercraft:tire_koukan player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 3 if items entity @s weapon.offhand kamenridercraft:midnightshadow run advancement grant @s only krc_snd:flags/zeztz/temporary midnight_shadow_drive
