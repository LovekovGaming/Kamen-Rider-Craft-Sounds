...
execute if score @s krc.henshin-stage matches 2..3 if score @s krc.seq1 matches 28 run function krc_snd:play_global {name:"kamenridercraft:valvarusher_standby_1",scope:"henshin_snd"}
execute if score @s krc.henshin-stage matches 4 if score @s krc.seq1 matches 18 run function krc_snd:play_global {name:"kamenridercraft:valvarusher_standby_2",scope:"henshin_snd"}
