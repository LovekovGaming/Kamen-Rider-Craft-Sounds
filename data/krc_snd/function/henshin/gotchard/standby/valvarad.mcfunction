...
execute if score @s krc.henshin-stage matches 2..3 if score @s krc.seq1 matches 28 run playsound kamenridercraft:valvarusher_standby_1 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.henshin-stage matches 4 if score @s krc.seq1 matches 18 run playsound kamenridercraft:valvarusher_standby_2 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
