...
execute if score @s krc.form1n matches 0 if score @s krc.configs.legend_type matches 0 run playsound kamenridercraft:legend_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 0 if score @s krc.configs.legend_type matches 1 run playsound kamenridercraft:legend_kotodaman player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 1..28 if score @s krc.configs.legend_type matches 0 run playsound kamenridercraft:legend_gorgeous player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 1..28 if score @s krc.configs.legend_type matches 1 run playsound kamenridercraft:legend_gorgeous_kotodaman player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 29.. if entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:legend_kamen_riser_mount player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 29.. if entity @s[advancements={krc_core:player_transformed=true}] unless predicate krc_core:sneaking run playsound kamenridercraft:legend_kamen_riser_mount player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 29.. if entity @s[advancements={krc_core:player_transformed=true}] if predicate krc_core:sneaking run playsound kamenridercraft:final_chemy_ride player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
