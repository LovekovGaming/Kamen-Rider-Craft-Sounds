...
advancement grant @s only krc_snd:henshin/gotchard/dreatrooper_seq 1
...
playsound kamenridercraft:dreadriver_open player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
