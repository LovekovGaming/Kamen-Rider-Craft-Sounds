...
execute unless items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:metal_machwheel_ride_chemy_card"}] run playsound kamenridercraft:valvaradriver_name player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:metal_machwheel_ride_chemy_card"}] run playsound kamenridercraft:valvaradriver_kurogane_name player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~
