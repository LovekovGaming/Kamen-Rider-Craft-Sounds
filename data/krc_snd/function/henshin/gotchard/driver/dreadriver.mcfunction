...
execute if score @s krc.seq1 matches 16 run playsound kamenridercraft:dreadriver_equip player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~ 3

execute if score @s krc.seq1 matches ..47 run return 0
execute if entity @s[advancements={krc_snd:henshin/gotchard/dreadriver_equip_seq={name=true}}] run playsound kamenridercraft:dreadriver_name player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~ 3
