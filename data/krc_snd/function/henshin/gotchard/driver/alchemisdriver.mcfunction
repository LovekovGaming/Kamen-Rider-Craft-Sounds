...
execute unless items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:twilight_the_sun_ride_chemy_card"}] run playsound kamenridercraft:alchemisdriver_name player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:twilight_the_sun_ride_chemy_card"}] run playsound kamenridercraft:majestydriver_name player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~
