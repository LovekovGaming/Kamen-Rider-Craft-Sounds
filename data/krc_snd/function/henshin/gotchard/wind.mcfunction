...
advancement grant @s only krc_snd:henshin/gotchard/wind_seq 1
...
stopsound @a[scores={krc.configs.henshin_snd=1},distance=..20] player kamenridercraft:alchemisdriver_standby_wind
...
playsound kamenridercraft:ggggotchanko_alchemisdriver player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
