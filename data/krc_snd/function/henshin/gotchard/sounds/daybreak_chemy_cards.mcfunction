...
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/daybreak_chemy_cards={hopper1=true}}] run playsound kamenridercraft:hopper1_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/daybreak_chemy_cards={steamliner=true}}] run playsound kamenridercraft:steamliner_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[advancements={krc_snd:henshin/gotchard/daybreak_chemy_cards={shining=true}}] run playsound kamenridercraft:shining_chemy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
