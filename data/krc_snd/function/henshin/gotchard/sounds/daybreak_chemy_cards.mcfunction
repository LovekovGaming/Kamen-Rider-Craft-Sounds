...
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/daybreak_chemy_cards={hopper1=true}}] run function krc_snd:play_global {name:"kamenridercraft:hopper1_card",scope:"henshin_snd"}
...
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/daybreak_chemy_cards={steamliner=true}}] run function krc_snd:play_global {name:"kamenridercraft:steamliner_card",scope:"henshin_snd"}
...
execute if entity @s[advancements={krc_snd:henshin/gotchard/daybreak_chemy_cards={shining=true}}] run function krc_snd:play_global {name:"kamenridercraft:shining_chemy",scope:"henshin_snd"}
