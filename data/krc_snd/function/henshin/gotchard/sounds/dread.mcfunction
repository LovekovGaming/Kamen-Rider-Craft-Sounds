...
execute if score @s krc.seq1 matches 48 if score @s krc.form1n matches 0 run playsound kamenridercraft:dread_zeroshiki player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 48 if score @s krc.form1n matches 1 run playsound kamenridercraft:dread_ichishiki player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 48 if score @s krc.form1n matches 2 run playsound kamenridercraft:dread_nishiki player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 48 if score @s krc.form1n matches 3 run playsound kamenridercraft:dread_sanshiki player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 48 if score @s krc.form1n matches 4 run playsound kamenridercraft:dread_shushiki player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
