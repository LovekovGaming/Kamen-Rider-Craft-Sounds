...
execute if score @s krc.seq2 matches 12 if entity @s[tag=machwheel] run playsound kamenridercraft:machwheel_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[tag=daiohni] run playsound kamenridercraft:daiohni_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[tag=gekiocopter] run playsound kamenridercraft:gekiocopter_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[tag=angelead] run playsound kamenridercraft:angelead_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[tag=gutsshovel] run playsound kamenridercraft:gutsshovel_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[tag=jyamatanoorochi] run playsound kamenridercraft:jyamatanoorochi_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[tag=gigantliner] run playsound kamenridercraft:gigantliner_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[advancements={krc_snd:henshin/gotchard/valvarad_chemy_cards={kurogane=false}}] run playsound kamenridercraft:igniter_chemy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if entity @s[advancements={krc_snd:henshin/gotchard/valvarad_chemy_cards={kurogane=true}}] if score @s krc.henshin-stage matches 1 run playsound kamenridercraft:valvaradriver_gakin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if entity @s[advancements={krc_snd:henshin/gotchard/valvarad_chemy_cards={kurogane=true}}] if score @s krc.henshin-stage matches 2 run playsound kamenridercraft:valvaradriver_gokin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
