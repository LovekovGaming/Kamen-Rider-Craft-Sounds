...
execute if entity @s[tag=gigabaham] run playsound kamenridercraft:gigabaham_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if entity @s[tag=gigabaham] run playsound kamenridercraft:gigabaham_alchemisdriver player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=kuroana] run playsound kamenridercraft:kuroana_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if entity @s[tag=kuroana] run playsound kamenridercraft:kuroana_alchemisdriver player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
