...
execute if entity @s[tag=x_rex] run playsound kamenridercraft:x_rex_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @s[tag=ufo_x] run playsound kamenridercraft:ufo_x_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
