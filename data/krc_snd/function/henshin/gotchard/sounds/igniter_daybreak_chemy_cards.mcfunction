...
execute if score @s krc.seq2 matches 12 if entity @s[tag=hopper1] run playsound kamenridercraft:hopper1_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq2 matches 12 if entity @s[tag=steamliner] run playsound kamenridercraft:steamliner_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
