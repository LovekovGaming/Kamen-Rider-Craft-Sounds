...
execute if score @s krc.seq1 matches 74 if score @s krc.form1n matches 0 run playsound kamenridercraft:sununicorn player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 74 if score @s krc.form1n matches 1 run playsound kamenridercraft:mooncerberus player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 74 if score @s krc.form1n matches 2 run playsound kamenridercraft:twilight_majade player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
