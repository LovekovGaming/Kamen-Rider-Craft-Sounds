...
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/chemy_cards={hopper1=true}}] run playsound kamenridercraft:hopper1_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/chemy_cards={antrooper=true}}] run playsound kamenridercraft:antrooper_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/chemy_cards={wrestler_g=true}}] run playsound kamenridercraft:wrestler_g_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/chemy_cards={apparebushido=true}}] run playsound kamenridercraft:apparebushido_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/chemy_cards={skebows=true}}] run playsound kamenridercraft:skebows_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/chemy_cards={steamliner=true}}] run playsound kamenridercraft:steamliner_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/chemy_cards={kuuga=true}}] run playsound kamenridercraft:kuuga_chemy_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/chemy_cards={faiz=true}}] run playsound kamenridercraft:faiz_chemy_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
