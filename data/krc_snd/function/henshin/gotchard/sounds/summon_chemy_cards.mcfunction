...
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/summon_chemy_cards={tenliner=true}}] run playsound kamenridercraft:tenliner_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 34 if entity @s[advancements={krc_snd:henshin/gotchard/summon_chemy_cards={tenliner=true}}] run playsound kamenridercraft:tenliner_summon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/summon_chemy_cards={crosshopper=true}}] run playsound kamenridercraft:crosshopper_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 34 if entity @s[advancements={krc_snd:henshin/gotchard/summon_chemy_cards={crosshopper=true}}] run playsound kamenridercraft:crosshopper_summon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq2 matches 12 if entity @s[advancements={krc_snd:henshin/gotchard/summon_chemy_cards={special=true}}] run playsound kamenridercraft:special_chemy_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 35 if entity @s[advancements={krc_snd:henshin/gotchard/summon_chemy_cards={special=true}}] if score @s krc.form2n matches 1 run playsound kamenridercraft:nijigon_summon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 35 if entity @s[advancements={krc_snd:henshin/gotchard/summon_chemy_cards={special=true}}] if score @s krc.form2n matches 2 run playsound kamenridercraft:lets_la_gon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
