execute if entity @s[tag=steamliner] run playsound kamenridercraft:steamliner_dread player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=unicon] run playsound kamenridercraft:unicon_dread player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=daiohni] run playsound kamenridercraft:daiohni_dread player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=antrooper] run playsound kamenridercraft:antrooper_dread player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=gigantliner] run playsound kamenridercraft:gigantliner_dread player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=buglesia] run playsound kamenridercraft:buglesia_dread player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=kamantis] run playsound kamenridercraft:kamantis_dread player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=carery] run playsound kamenridercraft:carery_dread player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
