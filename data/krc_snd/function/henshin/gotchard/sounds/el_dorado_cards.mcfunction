execute if entity @s[tag=dark_ether] run playsound kamenridercraft:dark_ether_chemy_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @s[tag=eldragon] run playsound kamenridercraft:eldragon_chemy_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
