...
execute if score @s krc.seq2 matches 12 if entity @s[tag=unicon] run playsound kamenridercraft:unicon_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq2 matches 12 if entity @s[tag=unicon] run playsound kamenridercraft:unicon_alchemisdriver player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq2 matches 12 if entity @s[tag=yoacerberus] run playsound kamenridercraft:yoacerberus_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq2 matches 12 if entity @s[tag=yoacerberus] run playsound kamenridercraft:yoacerberus_alchemisdriver player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq2 matches 12 if entity @s[tag=neminemoon] run playsound kamenridercraft:neminemoon_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq2 matches 12 if entity @s[tag=neminemoon] run playsound kamenridercraft:neminemoon_alchemisdriver player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq2 matches 12 if entity @s[tag=the_sun] run playsound kamenridercraft:the_sun_card player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq2 matches 12 if entity @s[tag=the_sun] run playsound kamenridercraft:the_sun_alchemisdriver player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @s[advancements={krc_snd:henshin/gotchard/majade_chemy_cards={twilight=true}}] run playsound kamenridercraft:twilight_chemy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
