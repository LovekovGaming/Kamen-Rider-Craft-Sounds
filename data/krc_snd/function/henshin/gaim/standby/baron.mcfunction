...
execute if score @s krc.seq1 matches 56 run playsound kamenridercraft:baron_start player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 131 run playsound kamenridercraft:baron_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
