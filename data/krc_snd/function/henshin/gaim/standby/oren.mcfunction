...
execute if score @s krc.seq1 matches 56 run playsound kamenridercraft:oren_start player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 114 run playsound kamenridercraft:oren_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
