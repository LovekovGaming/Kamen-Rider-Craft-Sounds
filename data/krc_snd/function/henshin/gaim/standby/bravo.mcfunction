...
execute if score @s krc.seq1 matches 56 run playsound kamenridercraft:bravo_start player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 101 run playsound kamenridercraft:bravo_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
