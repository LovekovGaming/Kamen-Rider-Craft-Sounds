...
execute if score @s krc.seq1 matches 56 run playsound kamenridercraft:ryugen_start player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 108 run playsound kamenridercraft:ryugen_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
