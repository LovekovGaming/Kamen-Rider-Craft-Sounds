...
execute if score @s krc.seq1 matches 56 run playsound kamenridercraft:saver_start player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 154 run playsound kamenridercraft:saver_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
