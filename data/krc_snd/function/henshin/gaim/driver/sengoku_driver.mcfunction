...
execute if score @s krc.seq1 matches 11 run playsound kamenridercraft:sengoku_driver_equip player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~ 3
execute if score @s[advancements={krc_snd:henshin/gaim/sengoku_driver_equip_seq={name=true}}] krc.seq1 matches 23 run playsound kamenridercraft:sengoku_driver_name player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~ 3
