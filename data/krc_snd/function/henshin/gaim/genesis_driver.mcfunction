...
execute if score @s krc.form1n matches 0..6 unless score @s krc.form1n matches 4..5 run function krc_snd:play_global {name:"kamenridercraft:genesis_soda",scope:"henshin_snd"}
