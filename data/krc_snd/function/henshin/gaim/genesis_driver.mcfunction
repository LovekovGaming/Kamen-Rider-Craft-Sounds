...
execute if score @s krc.form1n matches 0..3 run playsound kamenridercraft:genesis_soda player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 4.. unless score @s krc.form1n matches 5..6 run playsound kamenridercraft:genesis_liquid player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 5 run playsound kamenridercraft:genesis_soda_alt player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 6 run playsound kamenridercraft:genesis_soda player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
