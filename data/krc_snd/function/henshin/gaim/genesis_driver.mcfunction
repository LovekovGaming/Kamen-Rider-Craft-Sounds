...
execute if score @s krc.form1n matches 0..3 run function krc_snd:play_global {name:"kamenridercraft:genesis_soda",scope:"henshin_snd"}
execute if score @s krc.form1n matches 4.. unless score @s krc.form1n matches 5..6 run function krc_snd:play_global {name:"kamenridercraft:genesis_liquid",scope:"henshin_snd"}
execute if score @s krc.form1n matches 5 run function krc_snd:play_global {name:"kamenridercraft:genesis_soda_alt",scope:"henshin_snd"}
execute if score @s krc.form1n matches 6 run function krc_snd:play_global {name:"kamenridercraft:genesis_soda",scope:"henshin_snd"}
