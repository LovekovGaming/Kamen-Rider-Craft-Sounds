...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 0 run playsound kamenridercraft:lemon_energy_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 1 run playsound kamenridercraft:cherry_energy_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 2 run playsound kamenridercraft:peach_energy_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 3 run playsound kamenridercraft:melon_energy_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 4 run playsound kamenridercraft:matsubokkuri_energy_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 5..6 run playsound kamenridercraft:dragon_energy_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 34 run playsound kamenridercraft:drive_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 8 run playsound kamenridercraft:gaim_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 9 run playsound kamenridercraft:wizard_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 10 run playsound kamenridercraft:fourze_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 11 run playsound kamenridercraft:ooo_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 12 run playsound kamenridercraft:w_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 13 run playsound kamenridercraft:decade_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 14 run playsound kamenridercraft:kiva_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 15 run playsound kamenridercraft:den-o_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 16 run playsound kamenridercraft:kabuto_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 17 run playsound kamenridercraft:hibiki_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 18 run playsound kamenridercraft:blade_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 19 run playsound kamenridercraft:faiz_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 20 run playsound kamenridercraft:ryuki_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 21 run playsound kamenridercraft:agito_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 22 run playsound kamenridercraft:kuuga_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 23..24 run playsound kamenridercraft:ichigo_rider_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 25 run playsound kamenridercraft:gaim_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
