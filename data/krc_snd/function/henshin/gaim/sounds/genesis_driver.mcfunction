...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 0 run function krc_snd:play_global {name:"kamenridercraft:lemon_energy_arms",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:cherry_energy_arms",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 2 run function krc_snd:play_global {name:"kamenridercraft:peach_energy_arms",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 3 run function krc_snd:play_global {name:"kamenridercraft:melon_energy_arms",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 4 run function krc_snd:play_global {name:"kamenridercraft:matsubokkuri_energy_arms",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 5..6 run function krc_snd:play_global {name:"kamenridercraft:dragon_energy_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 34 run function krc_snd:play_global {name:"kamenridercraft:drive_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 8 run function krc_snd:play_global {name:"kamenridercraft:gaim_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 9 run function krc_snd:play_global {name:"kamenridercraft:wizard_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 10 run function krc_snd:play_global {name:"kamenridercraft:fourze_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 11 run function krc_snd:play_global {name:"kamenridercraft:ooo_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 12 run function krc_snd:play_global {name:"kamenridercraft:w_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 13 run function krc_snd:play_global {name:"kamenridercraft:decade_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 14 run function krc_snd:play_global {name:"kamenridercraft:kiva_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 15 run function krc_snd:play_global {name:"kamenridercraft:den-o_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 16 run function krc_snd:play_global {name:"kamenridercraft:kabuto_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 17 run function krc_snd:play_global {name:"kamenridercraft:hibiki_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 18 run function krc_snd:play_global {name:"kamenridercraft:blade_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 19 run function krc_snd:play_global {name:"kamenridercraft:faiz_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 20 run function krc_snd:play_global {name:"kamenridercraft:ryuki_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 21 run function krc_snd:play_global {name:"kamenridercraft:agito_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 22 run function krc_snd:play_global {name:"kamenridercraft:kuuga_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 23..24 run function krc_snd:play_global {name:"kamenridercraft:ichigo_rider_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 95 if score @s krc.form1n matches 25 run function krc_snd:play_global {name:"kamenridercraft:gaim_arms",scope:"henshin_snd"}
