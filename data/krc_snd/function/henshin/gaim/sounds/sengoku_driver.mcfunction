...
execute if score @s krc.seq1 matches 26 if score @s krc.form2n matches 1 if items entity @s armor.feet kamenridercraft:sengoku_driver_gaim run function krc_snd:play_global {name:"kamenridercraft:orange_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form2n matches 1 if items entity @s armor.feet kamenridercraft:sengoku_driver_ryugen run function krc_snd:play_global {name:"kamenridercraft:budou_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form2n matches 1 if items entity @s armor.feet kamenridercraft:sengoku_driver_zangetsu run function krc_snd:play_global {name:"kamenridercraft:melon_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form2n matches 1 if items entity @s armor.feet kamenridercraft:sengoku_driver_bravo run function krc_snd:play_global {name:"kamenridercraft:durian_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form2n matches 1 if items entity @s armor.feet kamenridercraft:sengoku_driver_knuckle run function krc_snd:play_global {name:"kamenridercraft:kurumi_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 0 run function krc_snd:play_global {name:"kamenridercraft:matsubokkuri_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:kurumi_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 2 run function krc_snd:play_global {name:"kamenridercraft:donguri_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 3 run function krc_snd:play_global {name:"kamenridercraft:melon_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 6 run function krc_snd:play_global {name:"kamenridercraft:orange_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 7 run function krc_snd:play_global {name:"kamenridercraft:banana_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 8 run function krc_snd:play_global {name:"kamenridercraft:budou_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 9 run function krc_snd:play_global {name:"kamenridercraft:suika_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 12 run function krc_snd:play_global {name:"kamenridercraft:kiwi_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 13 run function krc_snd:play_global {name:"kamenridercraft:lemon_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 14 run function krc_snd:play_global {name:"kamenridercraft:blood_orange_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 15 run function krc_snd:play_global {name:"kamenridercraft:fifteen_arms",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 15 run scoreboard players set @s krc.seq1 194
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 16 run function krc_snd:play_global {name:"kamenridercraft:golden_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 17 run function krc_snd:play_global {name:"kamenridercraft:silver_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 18 run function krc_snd:play_global {name:"kamenridercraft:darkness_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 19 run function krc_snd:play_global {name:"kamenridercraft:ringo_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 20 run function krc_snd:play_global {name:"kamenridercraft:watermelon_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 21 run function krc_snd:play_global {name:"kamenridercraft:maja_arms_alt",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 22 run function krc_snd:play_global {name:"kamenridercraft:orange_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 23 run function krc_snd:play_global {name:"kamenridercraft:fresh_orange_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 24 run function krc_snd:play_global {name:"kamenridercraft:lychee_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 25 run function krc_snd:play_global {name:"kamenridercraft:kingdurian_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 26 run function krc_snd:play_global {name:"kamenridercraft:hells_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 27 run function krc_snd:play_global {name:"kamenridercraft:natsumikan_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 28 run function krc_snd:play_global {name:"kamenridercraft:donguri_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 29 run function krc_snd:play_global {name:"kamenridercraft:orange_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 30 run function krc_snd:play_global {name:"kamenridercraft:banana_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 31 run function krc_snd:play_global {name:"kamenridercraft:budou_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 32 run function krc_snd:play_global {name:"kamenridercraft:durian_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 unless items entity @s armor.feet kamenridercraft:sengoku_driver_bujin_gaim if score @s krc.form1n matches 33 run function krc_snd:play_global {name:"kamenridercraft:blood_zakuro_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 127 unless items entity @s armor.feet kamenridercraft:sengoku_driver_bujin_gaim if score @s krc.form1n matches 33 run function krc_snd:play_global {name:"kamenridercraft:blood_orange_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if items entity @s armor.feet kamenridercraft:sengoku_driver_bujin_gaim if score @s krc.form1n matches 33 run function krc_snd:play_global {name:"kamenridercraft:ochimusha_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 34 run function krc_snd:play_global {name:"kamenridercraft:drive_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 35 run function krc_snd:play_global {name:"kamenridercraft:gaim_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 36 run function krc_snd:play_global {name:"kamenridercraft:wizard_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 37 run function krc_snd:play_global {name:"kamenridercraft:fourze_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 38 run function krc_snd:play_global {name:"kamenridercraft:ooo_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 39 run function krc_snd:play_global {name:"kamenridercraft:w_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 40 run function krc_snd:play_global {name:"kamenridercraft:decade_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 41 run function krc_snd:play_global {name:"kamenridercraft:kiva_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 42 run function krc_snd:play_global {name:"kamenridercraft:den-o_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 43 run function krc_snd:play_global {name:"kamenridercraft:kabuto_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 44 run function krc_snd:play_global {name:"kamenridercraft:hibiki_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 45 run function krc_snd:play_global {name:"kamenridercraft:blade_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 46 run function krc_snd:play_global {name:"kamenridercraft:faiz_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 47 run function krc_snd:play_global {name:"kamenridercraft:ryuki_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 48 run function krc_snd:play_global {name:"kamenridercraft:agito_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 49 run function krc_snd:play_global {name:"kamenridercraft:kuuga_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 50..51 run function krc_snd:play_global {name:"kamenridercraft:ichigo_rider_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 52 run function krc_snd:play_global {name:"kamenridercraft:gaim_arms",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 154 if score @s krc.form1n matches 53 run function krc_snd:play_global {name:"kamenridercraft:jimber_lemon",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 154 if score @s krc.form2n matches 2 run function krc_snd:play_global {name:"kamenridercraft:jimber_lemon",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 154 if score @s krc.form1n matches 54 run function krc_snd:play_global {name:"kamenridercraft:jimber_cherry",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 154 if score @s krc.form1n matches 55 run function krc_snd:play_global {name:"kamenridercraft:jimber_peach",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 154 if score @s krc.form1n matches 56 run function krc_snd:play_global {name:"kamenridercraft:jimber_melon",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 154 if score @s krc.form1n matches 57 run function krc_snd:play_global {name:"kamenridercraft:jimber_dragon_fruits",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 154 if score @s krc.form1n matches 58 run function krc_snd:play_global {name:"kamenridercraft:jimber_marron",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 26 if score @s krc.form1n matches 59 if items entity @s armor.feet kamenridercraft:sengoku_driver_ryugen run function krc_snd:play_global {name:"kamenridercraft:yomotsuheguri_arms",scope:"henshin_snd"}
