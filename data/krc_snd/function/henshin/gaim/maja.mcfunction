...
execute unless score @s krc.form1n matches 21 run playsound kamenridercraft:gaim_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 21 if predicate krc_core:sneaking run playsound kamenridercraft:gaim_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 21 unless predicate krc_core:sneaking run playsound kamenridercraft:maja_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
