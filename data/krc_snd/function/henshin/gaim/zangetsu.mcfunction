...
execute unless score @s krc.form1n matches 59 if score @s krc.form2n matches 0..1 run playsound kamenridercraft:gaim_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 59 run playsound kamenridercraft:kachidoki_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
