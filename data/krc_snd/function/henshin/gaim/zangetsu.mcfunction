...
execute unless score @s krc.form1n matches 59 if score @s krc.form2n matches 0..1 run function krc_snd:play_global {name:"kamenridercraft:gaim_henshin",scope:"henshin_snd"}
