...
execute unless score @s krc.form1n matches 60..61 if score @s krc.form2n matches 0 run playsound kamenridercraft:gaim_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 60 if score @s krc.form2n matches 0 run playsound kamenridercraft:kachidoki_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 61 unless predicate krc_core:sneaking run playsound kamenridercraft:kiwami_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 61 if predicate krc_core:sneaking run playsound kamenridercraft:kiwami_arms_alt player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 1 run playsound kamenridercraft:gaim_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 1..2 run playsound kamenridercraft:jimber_arms player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 2 run playsound kamenridercraft:gaim_yami_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
