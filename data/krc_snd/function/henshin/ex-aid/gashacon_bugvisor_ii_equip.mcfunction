...
execute if entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:bugvisor_zwei_equip player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~
