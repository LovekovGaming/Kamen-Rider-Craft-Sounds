...
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 0 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 0 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 0 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 0 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form1n matches 1..3 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form1n matches 1..3 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form1n matches 1..3 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form1n matches 1..3 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!no_gashat] krc.form1n matches 9.. if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=!no_gashat] krc.form1n matches 9.. if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=!no_gashat] krc.form1n matches 9.. if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=!no_gashat] krc.form1n matches 9.. if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 4 unless score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:god_maximum_mighty_x player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 4 if score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:maximum_mighty_x_return player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 5 run playsound kamenridercraft:maximum_mighty_x_eject player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~

execute if score @s[tag=!no_gashat] krc.form1n matches 6 run playsound kamenridercraft:musou_gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 7 run playsound kamenridercraft:hyper_fumetsu player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score Form_Difference krc.form1n matches 1.. unless score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. unless score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. unless score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. unless score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gachon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gachon_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gachon_vrx player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gachon_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 1..3 if score @s krc.form2n matches 0 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashuun player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 1..3 if score @s krc.form2n matches 0 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashuun_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 1..3 if score @s krc.form2n matches 0 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashuun_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 1..3 if score @s krc.form2n matches 0 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashuun_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
