...
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 0 if score @s krc.configs.gd_voice matches 0 run function krc_snd:play_global {name:"kamenridercraft:gashat",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 0 if score @s krc.configs.gd_voice matches 1 run function krc_snd:play_global {name:"kamenridercraft:gashat_poppy",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 0 if score @s krc.configs.gd_voice matches 2 run function krc_snd:play_global {name:"kamenridercraft:gashat_bugvisor_zwei",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 0 if score @s krc.configs.gd_voice matches 3 run function krc_snd:play_global {name:"kamenridercraft:gashat_build",scope:"henshin_snd"}
...
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 0 run function krc_snd:play_global {name:"kamenridercraft:gashat",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 1 run function krc_snd:play_global {name:"kamenridercraft:gashat_poppy",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 2 run function krc_snd:play_global {name:"kamenridercraft:gashat_bugvisor_zwei",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 3 run function krc_snd:play_global {name:"kamenridercraft:gashat_build",scope:"henshin_snd"}
...
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form1n matches 1..3 if score @s krc.configs.gd_voice matches 0 run function krc_snd:play_global {name:"kamenridercraft:gashat",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form1n matches 1..3 if score @s krc.configs.gd_voice matches 1 run function krc_snd:play_global {name:"kamenridercraft:gashat_poppy",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form1n matches 1..3 if score @s krc.configs.gd_voice matches 2 run function krc_snd:play_global {name:"kamenridercraft:gashat_bugvisor_zwei",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form1n matches 1..3 if score @s krc.configs.gd_voice matches 3 run function krc_snd:play_global {name:"kamenridercraft:gashat_build",scope:"henshin_snd"}
...
execute if score @s[tag=!no_gashat] krc.form1n matches 9.. if score @s krc.configs.gd_voice matches 0 run function krc_snd:play_global {name:"kamenridercraft:gashat",scope:"henshin_snd"}
execute if score @s[tag=!no_gashat] krc.form1n matches 9.. if score @s krc.configs.gd_voice matches 1 run function krc_snd:play_global {name:"kamenridercraft:gashat_poppy",scope:"henshin_snd"}
execute if score @s[tag=!no_gashat] krc.form1n matches 9.. if score @s krc.configs.gd_voice matches 2 run function krc_snd:play_global {name:"kamenridercraft:gashat_bugvisor_zwei",scope:"henshin_snd"}
execute if score @s[tag=!no_gashat] krc.form1n matches 9.. if score @s krc.configs.gd_voice matches 3 run function krc_snd:play_global {name:"kamenridercraft:gashat_build",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 4 unless score Form_Difference krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:god_maximum_mighty_x",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 4 if score Form_Difference krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:maximum_mighty_x_return",scope:"henshin_snd"}
execute if score @s krc.form1n matches 5 run function krc_snd:play_global {name:"kamenridercraft:maximum_mighty_x_eject",scope:"henshin_snd"}

execute if score @s[tag=!no_gashat] krc.form1n matches 6 run function krc_snd:play_global {name:"kamenridercraft:musou_gashat",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 7 run function krc_snd:play_global {name:"kamenridercraft:hyper_fumetsu",scope:"henshin_snd"}
...
execute if score Form_Difference krc.form1n matches 1.. unless score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 0 run function krc_snd:play_global {name:"kamenridercraft:gashat",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches 1.. unless score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 1 run function krc_snd:play_global {name:"kamenridercraft:gashat_poppy",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches 1.. unless score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 2 run function krc_snd:play_global {name:"kamenridercraft:gashat_bugvisor_zwei",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches 1.. unless score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 3 run function krc_snd:play_global {name:"kamenridercraft:gashat_build",scope:"henshin_snd"}
...
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 0 run function krc_snd:play_global {name:"kamenridercraft:gachon",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 1 run function krc_snd:play_global {name:"kamenridercraft:gachon_poppy",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 2 run function krc_snd:play_global {name:"kamenridercraft:gachon_vrx",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 8 if score @s krc.configs.gd_voice matches 3 run function krc_snd:play_global {name:"kamenridercraft:gachon_build",scope:"henshin_snd"}
...
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 1..3 if score @s krc.form2n matches 0 if score @s krc.configs.gd_voice matches 0 run function krc_snd:play_global {name:"kamenridercraft:gashuun",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 1..3 if score @s krc.form2n matches 0 if score @s krc.configs.gd_voice matches 1 run function krc_snd:play_global {name:"kamenridercraft:gashuun_poppy",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 1..3 if score @s krc.form2n matches 0 if score @s krc.configs.gd_voice matches 2 run function krc_snd:play_global {name:"kamenridercraft:gashuun_bugvisor_zwei",scope:"henshin_snd"}
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 1..3 if score @s krc.form2n matches 0 if score @s krc.configs.gd_voice matches 3 run function krc_snd:play_global {name:"kamenridercraft:gashuun_build",scope:"henshin_snd"}
