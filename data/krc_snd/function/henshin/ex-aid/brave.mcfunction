...
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form2n matches 1.. unless score @s krc.form2n matches 21..22 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form2n matches 1.. unless score @s krc.form2n matches 21..22 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form2n matches 1.. unless score @s krc.form2n matches 21..22 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form2n matches 1.. unless score @s krc.form2n matches 21..22 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[tag=!no_gashat] krc.form2n matches 21..22 run playsound kamenridercraft:dual_gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score Form_Difference krc.form1n matches 1.. unless score @s[advancements={krc_snd:henshin/ex-aid/brave_seq={1=true}}] krc.form2n matches 21..22 if score @s[tag=!no_gashat] krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score Form_Difference krc.form1n matches 1.. unless score @s[advancements={krc_snd:henshin/ex-aid/brave_seq={1=true}}] krc.form2n matches 21..22 if score @s[tag=!no_gashat] krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score Form_Difference krc.form1n matches 1.. unless score @s[advancements={krc_snd:henshin/ex-aid/brave_seq={1=true}}] krc.form2n matches 21..22 if score @s[tag=!no_gashat] krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score Form_Difference krc.form1n matches 1.. unless score @s[advancements={krc_snd:henshin/ex-aid/brave_seq={1=true}}] krc.form2n matches 21..22 if score @s[tag=!no_gashat] krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
