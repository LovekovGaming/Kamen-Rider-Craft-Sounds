...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 54 run playsound kamenridercraft:perfect_puzzle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 1 if score @s krc.seq1 matches 54 run playsound kamenridercraft:knock_out_fighter player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
