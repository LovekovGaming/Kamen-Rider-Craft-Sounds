...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 54 run function krc_snd:play_global {name:"kamenridercraft:perfect_puzzle",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 1 if score @s krc.seq1 matches 54 run function krc_snd:play_global {name:"kamenridercraft:knock_out_fighter",scope:"henshin_snd"}
