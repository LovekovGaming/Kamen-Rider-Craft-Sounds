...
execute if score @s krc.seq1 matches 30 run function krc_snd:play_global {name:"kamenridercraft:buggle_up",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 80 run function krc_snd:play_global {name:"kamenridercraft:dangerous_zombie",scope:"henshin_snd"}
