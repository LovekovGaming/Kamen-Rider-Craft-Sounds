...
execute if score @s krc.seq1 matches 30 run playsound kamenridercraft:buggle_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 80 run playsound kamenridercraft:dangerous_zombie player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
