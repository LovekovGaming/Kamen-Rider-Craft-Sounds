...
execute if score @s krc.form1n matches 0 if entity @s[tag=!no_gashat] run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 1 run playsound kamenridercraft:totema_exterior player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
