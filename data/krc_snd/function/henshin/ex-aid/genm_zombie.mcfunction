...
execute if score @s krc.form1n matches 0 if entity @s[tag=!no_gashat] run function krc_snd:play_global {name:"kamenridercraft:gashat",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:totema_exterior",scope:"henshin_snd"}
