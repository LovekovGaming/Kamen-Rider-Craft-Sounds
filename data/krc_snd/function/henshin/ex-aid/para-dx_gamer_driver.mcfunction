...
execute if score @s[tag=!no_gashat] krc.form1n matches 0 run playsound kamenridercraft:dual_gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!no_gashat] krc.form1n matches 1 run playsound kamenridercraft:double_gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
