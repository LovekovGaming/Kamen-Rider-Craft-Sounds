...
execute if score @s krc.seq1 matches 10 run function krc_snd:play_global {name:"kamenridercraft:perfect_puzzle_activate",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 45 run function krc_snd:play_global {name:"kamenridercraft:perfect_puzzle_standby",scope:"henshin_snd"}
