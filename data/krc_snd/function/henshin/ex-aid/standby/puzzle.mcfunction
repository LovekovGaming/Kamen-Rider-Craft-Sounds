...
execute if score @s krc.seq1 matches 10 run playsound kamenridercraft:perfect_puzzle_activate player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 45 run playsound kamenridercraft:perfect_puzzle_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
