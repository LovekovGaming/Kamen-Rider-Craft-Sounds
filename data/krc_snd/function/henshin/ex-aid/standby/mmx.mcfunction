...
execute if score @s krc.seq1 matches 29 run playsound kamenridercraft:level_max player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 74 run playsound kamenridercraft:maximum_mighty_x_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
