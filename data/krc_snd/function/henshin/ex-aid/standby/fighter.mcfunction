...
execute if score @s krc.seq1 matches 10 run playsound kamenridercraft:knock_out_fighter_activate player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 36 run playsound kamenridercraft:knock_out_fighter_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
