...
execute if score @s krc.seq1 matches 29 run playsound kamenridercraft:fumetsu player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 84 run playsound kamenridercraft:god_maximum_mighty_x_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
