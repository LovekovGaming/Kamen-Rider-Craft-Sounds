...
execute if score @s krc.seq1 matches 29 run function krc_snd:play_global {name:"kamenridercraft:fumetsu",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 84 run function krc_snd:play_global {name:"kamenridercraft:god_maximum_mighty_x_standby",scope:"henshin_snd"}
