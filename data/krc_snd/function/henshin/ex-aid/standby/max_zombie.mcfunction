...
execute if score @s krc.seq1 matches 29 run playsound kamenridercraft:zombie_maximum player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 74 run playsound kamenridercraft:maximum_zombie_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
