...
execute if score @s krc.seq1 matches 10 run playsound kamenridercraft:bang_bang_simulations_activate player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 48 run playsound kamenridercraft:bang_bang_simulations_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
