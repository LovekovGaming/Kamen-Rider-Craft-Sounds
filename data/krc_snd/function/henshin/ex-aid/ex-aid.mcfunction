...
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form1n matches ..1 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form1n matches ..1 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form1n matches ..1 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s[tag=!no_gashat] krc.form1n matches ..1 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!no_gashat] krc.form1n matches 40 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 12 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 12 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 12 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches ..0 if score @s krc.form1n matches 12 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!no_gashat] krc.form1n matches 2 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=!no_gashat] krc.form1n matches 2 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=!no_gashat] krc.form1n matches 2 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!no_gashat] krc.form1n matches 3 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=!no_gashat] krc.form1n matches 4 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=!no_gashat] krc.form1n matches 4 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=!no_gashat] krc.form1n matches 4 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=!no_gashat] krc.form1n matches 4 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!no_gashat] krc.form1n matches 8 run playsound kamenridercraft:double_gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!no_gashat] krc.form1n matches 13.. if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=!no_gashat] krc.form1n matches 13.. if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=!no_gashat] krc.form1n matches 13.. if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=!no_gashat] krc.form1n matches 13.. if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score Form_Difference krc.form1n matches 1.. unless score @s krc.form1n matches 5..7 unless score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. unless score @s krc.form1n matches 5..7 unless score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. unless score @s krc.form1n matches 5..7 unless score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. unless score @s krc.form1n matches 5..7 unless score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 1 if score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 1 if score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashat_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 1 if score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashat_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 1 if score @s[tag=!no_gashat] krc.form2n matches 0 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashat_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!no_gashat] krc.form1n matches 5 run playsound kamenridercraft:double_gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score Form_Difference krc.form1n matches -2..-1 if score @s[tag=!no_gashat] krc.form1n matches 7 run playsound kamenridercraft:double_gashat player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 9 unless score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:maximum_mighty_x player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 9 if score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:maximum_mighty_x_return player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 10 run playsound kamenridercraft:maximum_mighty_x_eject player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 11 unless score Form_Difference krc.form1n matches -2 run playsound kamenridercraft:maximum_mighty_x_return player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 11 run playsound kamenridercraft:hyper_muteki player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 12 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gachon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 12 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gachon_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 12 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gachon_vrx player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score Form_Difference krc.form1n matches 1.. if score @s krc.form1n matches 12 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gachon_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless entity @s[advancements={krc_core:player_transformed=false}] if score Form_Difference krc.form1n matches 0 if score @s krc.form2n matches 0 if score @s krc.configs.gd_voice matches 0 run playsound kamenridercraft:gashuun player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute unless entity @s[advancements={krc_core:player_transformed=false}] if score Form_Difference krc.form1n matches 0 if score @s krc.form2n matches 0 if score @s krc.configs.gd_voice matches 1 run playsound kamenridercraft:gashuun_poppy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute unless entity @s[advancements={krc_core:player_transformed=false}] if score Form_Difference krc.form1n matches 0 if score @s krc.form2n matches 0 if score @s krc.configs.gd_voice matches 2 run playsound kamenridercraft:gashuun_bugvisor_zwei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute unless entity @s[advancements={krc_core:player_transformed=false}] if score Form_Difference krc.form1n matches 0 if score @s krc.form2n matches 0 if score @s krc.configs.gd_voice matches 3 run playsound kamenridercraft:gashuun_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
