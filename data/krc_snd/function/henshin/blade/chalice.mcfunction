...
execute if score @s krc.form1n matches 0 unless score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:chalice_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 1 unless score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:chalice_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 1 if score Form_Difference krc.form1n matches -1 if entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:chalice_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 2 run playsound kamenridercraft:wild_chalice player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[advancements={krc_core:player_transformed=true}] krc.form1n matches 3 unless score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:chalice_detransform player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
