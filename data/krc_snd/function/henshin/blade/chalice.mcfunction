...
execute if score @s krc.form1n matches 0 unless score Form_Difference krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:chalice_henshin",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 1 unless score Form_Difference krc.form1n matches -1 run function krc_snd:play_global {name:"kamenridercraft:chalice_henshin",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 1 if score Form_Difference krc.form1n matches -1 if entity @s[advancements={krc_core:player_transformed=false}] run function krc_snd:play_global {name:"kamenridercraft:chalice_henshin",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 2 run function krc_snd:play_global {name:"kamenridercraft:wild_chalice",scope:"henshin_snd"}
...
execute if score @s[advancements={krc_core:player_transformed=true}] krc.form1n matches 3 unless score Form_Difference krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:chalice_detransform",scope:"henshin_snd"}
