...
execute if score @s krc.form1n matches 2..3 unless entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:king_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 2..3 if entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:king_form_decade player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
