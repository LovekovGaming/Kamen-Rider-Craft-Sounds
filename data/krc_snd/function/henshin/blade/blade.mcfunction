...
execute if score @s krc.form1n matches 0 unless score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:blade_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 1 unless score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:blade_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 1 if score Form_Difference krc.form1n matches -1 if entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:blade_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 2 unless score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:blade_jack player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 3 unless score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:blade_jack player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 4 unless entity @s[advancements={krc_core:player_transformed=false}] unless score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:king_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 5 unless entity @s[advancements={krc_core:player_transformed=false}] unless score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:king_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 4..5 if entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:king_form_decade player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
