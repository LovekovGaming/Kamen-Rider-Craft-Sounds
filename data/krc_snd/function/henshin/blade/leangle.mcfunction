...
execute if score @s krc.form1n matches 0..1 run playsound kamenridercraft:leangle_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 2 run playsound kamenridercraft:blade_jack player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 3 run playsound kamenridercraft:king_form player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
