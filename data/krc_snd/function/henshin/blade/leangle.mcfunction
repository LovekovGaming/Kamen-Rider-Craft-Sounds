...
execute if score @s krc.form1n matches 0..1 run function krc_snd:play_global {name:"kamenridercraft:leangle_henshin",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 2 run function krc_snd:play_global {name:"kamenridercraft:blade_jack",scope:"henshin_snd"}
