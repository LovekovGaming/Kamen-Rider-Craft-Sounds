...
execute if score @s[tag=set_creation] krc.seq1 matches 38 run playsound kamenridercraft:builder_buckle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=!set_creation,tag=!gigant_almighty,tag=gigant_sword] run playsound kamenridercraft:gigant_sword_seeker player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=!set_creation,tag=!gigant_almighty,tag=gigant_hammer] run playsound kamenridercraft:gigant_hammer_seeker player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=!set_creation,tag=!gigant_almighty,tag=gigant_blaster] run playsound kamenridercraft:gigant_blaster_seeker player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=!set_creation,tag=!gigant_almighty,tag=gigant_shooter] run playsound kamenridercraft:gigant_shooter_seeker player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=!set_creation,tag=!gigant_almighty,tag=gigant_dueler] run playsound kamenridercraft:gigant_dueler_seeker player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=!set_creation,tag=!gigant_almighty,tag=gigant_breaker] run playsound kamenridercraft:gigant_breaker_seeker player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=!set_creation,tag=!gigant_almighty,tag=gigant_arms] run playsound kamenridercraft:gigant_arms_seeker player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=gigant_almighty] run playsound kamenridercraft:gigant_almighty player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if entity @s[tag=set_creation] run playsound kamenridercraft:builder_rf player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
