...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 80 run playsound kamenridercraft:beroba player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 1 if score @s krc.seq1 matches 86 run playsound kamenridercraft:premium_beroba player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
