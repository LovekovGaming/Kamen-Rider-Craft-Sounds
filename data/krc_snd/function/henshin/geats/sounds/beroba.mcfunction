...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 80 run function krc_snd:play_global {name:"kamenridercraft:beroba",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 1 if score @s krc.seq1 matches 86 run function krc_snd:play_global {name:"kamenridercraft:premium_beroba",scope:"henshin_snd"}
