...
execute if score @s[tag=builder_hybrid] krc.seq2 matches 10 run playsound kamenridercraft:builder_hybrid player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[tag=builder_all_might] krc.seq2 matches 10 run playsound kamenridercraft:builder_all_might player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @s[tag=gigant_sword] run playsound kamenridercraft:gigant_sword_set player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @s[tag=gigant_hammer] run playsound kamenridercraft:gigant_hammer_set player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @s[tag=gigant_blaster] run playsound kamenridercraft:gigant_blaster_set player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @s[tag=gigant_shooter] run playsound kamenridercraft:gigant_shooter_set player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @s[tag=gigant_dueler] run playsound kamenridercraft:gigant_dueler_set player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @s[tag=gigant_breaker] run playsound kamenridercraft:gigant_breaker_set player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @s[tag=gigant_arms] run playsound kamenridercraft:gigant_arms_set player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
