...
execute if score Form_Difference krc.form1n matches -1 run function krc_snd:play_global {name:"kamenridercraft:hacking_on",scope:"henshin_snd"}
...
execute unless score Form_Difference krc.form1n matches -1 if score @s krc.form2n matches 1.. run function krc_snd:play_global {name:"kamenridercraft:remote_control",scope:"henshin_snd"}
...
execute unless score Form_Difference krc.form1n matches -1 unless score @s krc.form2n matches 1.. if score @s krc.form3n matches 1.. run function krc_snd:play_global {name:"kamenridercraft:remote_control",scope:"henshin_snd"}
