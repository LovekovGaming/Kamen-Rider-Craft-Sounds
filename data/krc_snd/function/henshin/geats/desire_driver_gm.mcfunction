...
execute if score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:hacking_on player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute unless score Form_Difference krc.form1n matches -1 if score @s krc.form2n matches 1.. run playsound kamenridercraft:remote_control player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute unless score Form_Difference krc.form1n matches -1 unless score @s krc.form2n matches 1.. if score @s krc.form3n matches 1.. run playsound kamenridercraft:remote_control player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
