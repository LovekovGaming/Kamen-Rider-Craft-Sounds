...
execute if score @s krc.configs.glare_type matches 0 run playsound kamenridercraft:glare player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.configs.glare_type matches 1 run playsound kamenridercraft:glare_alt player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
