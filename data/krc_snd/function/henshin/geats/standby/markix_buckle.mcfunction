...
execute if score @s krc.henshin-stage matches 1 if score @s krc.seq1 matches 63 run playsound kamenridercraft:boost_markix_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.henshin-stage matches 2.. if score @s krc.seq1 matches 63 run playsound kamenridercraft:desire_driver_standby_geatsix player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
