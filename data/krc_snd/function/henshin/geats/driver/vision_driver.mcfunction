...
execute if score @s krc.seq1 matches 16 run playsound kamenridercraft:vision_driver_equip player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~
...
execute if entity @s[advancements={krc_snd:henshin/geats/vision_driver_equip_seq={name=true}}] run playsound kamenridercraft:vision_driver_name player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~
