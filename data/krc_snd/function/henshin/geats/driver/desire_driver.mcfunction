...
execute if score @s krc.seq1 matches 16 run playsound kamenridercraft:desire_driver_equip player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~
...
execute unless items entity @s[advancements={krc_snd:henshin/geats/desire_driver_equip_seq={name=true}}] armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:buffa_rider_core_id_cracked"}] run playsound kamenridercraft:desire_driver_name player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~
...
execute if items entity @s[advancements={krc_snd:henshin/geats/desire_driver_equip_seq={name=true}}] armor.feet *[minecraft:custom_data~{slot_tex1:"kamenridercraft:buffa_rider_core_id_cracked"}] run playsound kamenridercraft:desire_driver_name_error player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~
