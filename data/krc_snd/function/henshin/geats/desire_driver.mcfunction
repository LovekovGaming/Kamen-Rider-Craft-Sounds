...
execute if entity @s[advancements={krc_core:player_transformed=false}] unless score @s krc.form1n matches 2 if score @s krc.form2n matches ..0 if score @s krc.form3n matches ..0 run playsound kamenridercraft:entry player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @s[advancements={krc_core:player_transformed=false}] if score @s krc.form1n matches 2 if score @s krc.form2n matches ..0 if score @s krc.form3n matches ..0 run playsound kamenridercraft:entry_error player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 1 run playsound kamenridercraft:beat_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 1 run scoreboard players add @s krc.seq1 50
execute if score @s krc.form2n matches 2 run playsound kamenridercraft:fantasy_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 2 run scoreboard players add @s krc.seq1 53
execute if score @s krc.form2n matches 3 run playsound kamenridercraft:monster_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 3 run scoreboard players add @s krc.seq1 66
execute if score @s krc.form2n matches 4 run playsound kamenridercraft:ninja_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 4 run scoreboard players add @s krc.seq1 65
execute if score @s krc.form2n matches 5 run playsound kamenridercraft:zombie_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 5 run scoreboard players add @s krc.seq1 52
execute if score @s krc.form2n matches 6 run playsound kamenridercraft:magnum_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 6 run scoreboard players add @s krc.seq1 43
execute if score @s krc.form2n matches 7 run playsound kamenridercraft:boost_active_1 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 7 run scoreboard players add @s krc.seq1 55
execute if score @s krc.form2n matches 8 run playsound kamenridercraft:propeller_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 8 run scoreboard players add @s krc.seq1 60
execute if score @s krc.form2n matches 9 run playsound kamenridercraft:drill_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 9 run scoreboard players add @s krc.seq1 68
execute if score @s krc.form2n matches 10 run playsound kamenridercraft:chain_array_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 10 run scoreboard players add @s krc.seq1 70
execute if score @s krc.form2n matches 11 run playsound kamenridercraft:claw_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 11 run scoreboard players add @s krc.seq1 77
execute if score @s krc.form2n matches 12 run playsound kamenridercraft:water_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 12 run scoreboard players add @s krc.seq1 57
execute if score @s krc.form2n matches 13 run playsound kamenridercraft:arrow_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 13 run scoreboard players add @s krc.seq1 62
execute if score @s krc.form2n matches 14 run playsound kamenridercraft:shield_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 14 run scoreboard players add @s krc.seq1 80
execute if score @s krc.form2n matches 15 run playsound kamenridercraft:hammer_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 15 run scoreboard players add @s krc.seq1 78
execute if score @s krc.form2n matches 16..29 unless score @s krc.form3n matches 1..15 unless score @s krc.form3n matches 30.. run playsound kamenridercraft:fever_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 30 unless score @s krc.form3n matches 1..15 unless score @s krc.form3n matches 31..32 unless score @s krc.form3n matches 36 unless score @s krc.form3n matches 39.. run playsound kamenridercraft:builder_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 31 unless score Form_Difference krc.form2n matches 0 run playsound kamenridercraft:jyamato_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 32 unless score @s krc.form3n matches 33 run playsound kamenridercraft:command_jet player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 32 unless score @s krc.form3n matches 33 run scoreboard players add @s krc.seq1 46
execute if score @s krc.form2n matches 32 if score @s krc.form3n matches 33 run playsound kamenridercraft:command_cannon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 32 if score @s krc.form3n matches 33 run scoreboard players add @s krc.seq1 188
execute if score @s krc.form2n matches 34 run playsound kamenridercraft:boost_markii_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 34 run scoreboard players add @s krc.seq1 184
execute if score @s krc.form2n matches 35 run playsound kamenridercraft:laserboost player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 35 run scoreboard players set @s krc.seq1 220
execute if score @s krc.form2n matches 36 unless score @s krc.form3n matches 36 run playsound kamenridercraft:boost_markiii_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 36 unless score @s krc.form3n matches 36 run scoreboard players set @s krc.seq1 43
execute if score @s krc.form2n matches 36 if score @s krc.form3n matches 36 if score @s krc.configs.geatsix_type matches 0 run playsound kamenridercraft:geatsix player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 36 if score @s krc.form3n matches 36 if score @s krc.configs.geatsix_type matches 1 run playsound kamenridercraft:geatsix_kotodaman player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 37 run playsound kamenridercraft:geats_oneness player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 37 run scoreboard players set @s krc.seq1 220
execute if score @s krc.form2n matches 38 unless score @s krc.form3n matches 1..15 unless score @s krc.form3n matches 30.. run playsound kamenridercraft:shinobi_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 39 unless score @s krc.form3n matches 33 run playsound kamenridercraft:command_jet player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 1 run playsound kamenridercraft:beat_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 2 run playsound kamenridercraft:fantasy_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 3 run playsound kamenridercraft:monster_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 4 run playsound kamenridercraft:ninja_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 5 run playsound kamenridercraft:zombie_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 6 run playsound kamenridercraft:magnum_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 7 run playsound kamenridercraft:boost_active_1 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36..37 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 36 run playsound kamenridercraft:boost_markiii_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 8 run playsound kamenridercraft:propeller_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 9 run playsound kamenridercraft:drill_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 10 run playsound kamenridercraft:chain_array_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 11 run playsound kamenridercraft:claw_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 12 run playsound kamenridercraft:water_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 13 run playsound kamenridercraft:arrow_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 14 run playsound kamenridercraft:shield_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 15 run playsound kamenridercraft:hammer_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1.. if score @s krc.form3n matches 16..29 run playsound kamenridercraft:fever_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 30..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39.. if score @s krc.form3n matches 30 run playsound kamenridercraft:builder_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 30..32 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s[tag=!special_buckle_override] krc.form3n matches 31 run playsound kamenridercraft:jyamato_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!special_buckle_override] krc.form2n matches 30 if score @s krc.form3n matches 31 run playsound kamenridercraft:jyamato_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute unless score @s krc.form2n matches 1..15 unless score @s krc.form2n matches 31..33 unless score @s krc.form2n matches 36 unless score @s krc.form2n matches 39 if score @s krc.form3n matches 32 run playsound kamenridercraft:command_jet player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 1 run playsound kamenridercraft:beat_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 2 run playsound kamenridercraft:fantasy_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 3 run playsound kamenridercraft:monster_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 4 run playsound kamenridercraft:ninja_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 5 run playsound kamenridercraft:zombie_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 6 run playsound kamenridercraft:magnum_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 7 run playsound kamenridercraft:boost_active_1 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 36 run playsound kamenridercraft:boost_markiii_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 8 run playsound kamenridercraft:propeller_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 9 run playsound kamenridercraft:drill_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 10 run playsound kamenridercraft:chain_array_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 11 run playsound kamenridercraft:claw_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 12 run playsound kamenridercraft:water_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 13 run playsound kamenridercraft:arrow_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 14 run playsound kamenridercraft:shield_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 15 run playsound kamenridercraft:hammer_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 16..29 if score @s krc.form3n matches 31 run playsound kamenridercraft:fever_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 16..29 run playsound kamenridercraft:fever_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 30 if score @s krc.form3n matches 31 run playsound kamenridercraft:builder_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 30 run playsound kamenridercraft:builder_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 31 unless score Form_Difference krc.form3n matches 0 run playsound kamenridercraft:jyamato_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 31 if score @s krc.form3n matches 32 run playsound kamenridercraft:command_jet player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=special_buckle_override] krc.form2n matches 38 if score @s krc.form3n matches 31 run playsound kamenridercraft:shinobi_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form2n matches 33 if score @s krc.form3n matches 32 run playsound kamenridercraft:command_cannon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form2n matches 33 if score @s krc.form3n matches 32 run scoreboard players add @s krc.seq1 188
execute unless score @s krc.form2n matches 1.. if score @s krc.form3n matches 37 run playsound kamenridercraft:bujin_sword_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute unless score @s krc.form2n matches 1.. if score @s krc.form3n matches 37 run scoreboard players add @s krc.seq1 71
execute unless score @s krc.form2n matches 1.. if score @s krc.form3n matches 38 run playsound kamenridercraft:plosion_rage_active player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
