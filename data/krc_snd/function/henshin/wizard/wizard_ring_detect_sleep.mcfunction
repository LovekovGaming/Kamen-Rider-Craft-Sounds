...
execute if items entity @s armor.feet #krc_snd:wizardriver run playsound kamenridercraft:sleep_ring player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet #krc_snd:white_wizardriver run playsound kamenridercraft:sleep_ring_white player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
