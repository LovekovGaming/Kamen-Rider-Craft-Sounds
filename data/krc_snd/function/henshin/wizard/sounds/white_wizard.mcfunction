...
execute if score @s krc.seq1 matches 25 run playsound kamenridercraft:white_wizardriver_now player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
playsound kamenridercraft:white_wizardriver_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
