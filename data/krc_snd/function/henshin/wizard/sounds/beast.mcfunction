...
execute if score @s krc.seq1 matches 16 if score @s krc.form1n matches 1 run playsound kamenridercraft:beast_falco player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 16 if score @s krc.form1n matches 2 run playsound kamenridercraft:beast_chameleo player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 16 if score @s krc.form1n matches 3 run playsound kamenridercraft:beast_buffa player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 16 if score @s krc.form1n matches 4 run playsound kamenridercraft:beast_dolphi player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 16 if score @s krc.form1n matches 5 run playsound kamenridercraft:beast_hyper player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 52 if score @s krc.form1n matches 6 run playsound kamenridercraft:wizardriver_dragon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 94 if score @s krc.form1n matches 6 run playsound kamenridercraft:wizard_land_dragon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
