...
execute if score @s krc.seq1 matches 1 run function krc_snd:play_global {name:"kamenridercraft:white_wizardriver_start",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 6 run function krc_snd:play_global {name:"kamenridercraft:white_wizardriver_start",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 46 run function krc_snd:play_global {name:"kamenridercraft:white_wizard_standby_change",scope:"henshin_snd"}
