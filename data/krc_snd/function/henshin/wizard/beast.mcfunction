...
execute if score @s krc.form1n matches 0 run playsound kamenridercraft:beast_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 1..5 run playsound kamenridercraft:beast_go player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 6 run playsound kamenridercraft:land_dragon_ring player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
