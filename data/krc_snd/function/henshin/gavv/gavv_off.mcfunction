...
execute unless score @s krc.form1n matches 13 run playsound kamenridercraft:gavv_detransform player @a[scores={krc.configs.detransform_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 13 run playsound kamenridercraft:gavv_detransform_blizzardsorbet player @a[scores={krc.configs.detransform_snd=1}] ~ ~1 ~
