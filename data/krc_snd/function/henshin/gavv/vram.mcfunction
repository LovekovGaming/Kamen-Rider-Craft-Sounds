...
execute unless score @s krc.form1n matches 2 run playsound kamenridercraft:vrastumgear_lever_down player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 2 run playsound kamenridercraft:a_la_mode_mode player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
