...
execute if score @s krc.seq2 matches 22 run function krc_snd:play_global {name:"kamenridercraft:eat_eat",scope:"henshin_snd"}
...
execute if score @s krc.seq2 matches 49 run function krc_snd:play_global {name:"kamenridercraft:eat_eat",scope:"henshin_snd"}
