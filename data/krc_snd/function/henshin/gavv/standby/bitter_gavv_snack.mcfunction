...
execute if score @s krc.seq2 matches 17 run playsound kamenridercraft:bite_snack player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq2 matches 39 run playsound kamenridercraft:bite_snack player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
