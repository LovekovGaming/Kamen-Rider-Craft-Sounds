...
execute if score @s krc.seq2 matches 17 run function krc_snd:play_global {name:"kamenridercraft:bite_snack",scope:"henshin_snd"}
...
execute if score @s krc.seq2 matches 39 run function krc_snd:play_global {name:"kamenridercraft:bite_snack",scope:"henshin_snd"}
