...
execute if score @s krc.seq1 matches 28 run playsound kamenridercraft:doughnut_gochizo_valen player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 50 run playsound kamenridercraft:set_doughnut player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 80 run playsound kamenridercraft:set_doughnut player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
