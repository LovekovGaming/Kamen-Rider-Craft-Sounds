...
execute if score @s krc.seq1 matches 28 run playsound kamenridercraft:choco_gochizo_valen player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 46 run playsound kamenridercraft:set_choco player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 70 run playsound kamenridercraft:set_choco player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
