...
execute if score @s krc.seq2 matches 17 run playsound kamenridercraft:bite_cookie player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq2 matches 42 run playsound kamenridercraft:bite_cookie player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
