...
execute if score @s krc.seq2 matches 22 run playsound kamenridercraft:eat_candy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq2 matches 49 run playsound kamenridercraft:eat_candy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
