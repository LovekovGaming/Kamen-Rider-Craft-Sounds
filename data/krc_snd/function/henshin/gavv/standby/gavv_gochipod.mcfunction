...
execute if score @s[advancements={krc_snd:flags/gavv/temporary={gochipod_master=false}}] krc.seq1 matches 30 run playsound kamenridercraft:gochipod_over player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_snd:flags/gavv/temporary={gochipod_master=true}}] krc.seq1 matches 30 run playsound kamenridercraft:gochipod_master player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 56 run playsound kamenridercraft:gavv_standby_gochipod player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
