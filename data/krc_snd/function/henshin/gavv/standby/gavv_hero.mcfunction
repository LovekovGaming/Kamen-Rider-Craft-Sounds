...
execute if score @s krc.seq2 matches 22 run playsound kamenridercraft:super_hero_gavv player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq2 matches 53 run playsound kamenridercraft:super_hero_gavv player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
