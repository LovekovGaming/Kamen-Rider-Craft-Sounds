...
execute if score @s krc.seq1 matches 28 run playsound kamenridercraft:cake_gochizo_valen player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 48 run playsound kamenridercraft:set_cake player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 76 run playsound kamenridercraft:set_cake player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
