...
execute if score @s krc.seq1 matches 31 if score @s krc.form1n matches 0 run playsound kamenridercraft:doppudding player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 31 if score @s krc.form1n matches 0 run scoreboard players add @s krc.seq1 100
execute if score @s krc.seq1 matches 31 if score @s krc.form1n matches 1 run playsound kamenridercraft:purujelly player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 31 if score @s krc.form1n matches 3 run playsound kamenridercraft:purujelly_noir player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
