...
execute if score @s krc.seq1 matches 31 if score @s krc.form1n matches 0 run function krc_snd:play_global {name:"kamenridercraft:doppudding",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 31 if score @s krc.form1n matches 0 run scoreboard players add @s krc.seq1 100
execute if score @s krc.seq1 matches 31 if score @s krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:purujelly",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 31 if score @s krc.form1n matches 3 run function krc_snd:play_global {name:"kamenridercraft:purujelly_noir",scope:"henshin_snd"}
