...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 52 run playsound kamenridercraft:caries_c1 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 1 if score @s krc.seq1 matches 52 run playsound kamenridercraft:caries_c3 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
