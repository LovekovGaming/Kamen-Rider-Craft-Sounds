...
execute if score @s krc.form1n matches 0 if score @s krc.seq1 matches 52 run function krc_snd:play_global {name:"kamenridercraft:caries_c1",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 1 if score @s krc.seq1 matches 52 run function krc_snd:play_global {name:"kamenridercraft:caries_c3",scope:"henshin_snd"}
