...
execute if score @s krc.seq1 matches 24 if score @s krc.form1n matches 0 run playsound kamenridercraft:chocodon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 24 if score @s krc.form1n matches 0 run scoreboard players add @s krc.seq1 7
execute if score @s krc.seq1 matches 24 if score @s krc.form1n matches 1 run playsound kamenridercraft:doumaru player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 24 if score @s krc.form1n matches 1 run scoreboard players add @s krc.seq1 4
execute if score @s krc.seq1 matches 24 if score @s krc.form1n matches 2 run playsound kamenridercraft:bushel_valen player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 24 if score @s krc.form1n matches 2 run scoreboard players add @s krc.seq1 9
execute if score @s krc.seq1 matches 24 if score @s krc.form1n matches 3 run playsound kamenridercraft:chocold player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 24 if score @s krc.form1n matches 4 run playsound kamenridercraft:tirol_choco_valen player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
