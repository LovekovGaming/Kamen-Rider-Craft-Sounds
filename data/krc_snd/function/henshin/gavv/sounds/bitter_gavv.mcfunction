...
execute if score @s krc.seq1 matches 39 if score @s krc.form1n matches 0 run playsound kamenridercraft:sparkingummy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 39 if score @s krc.form1n matches 1 run playsound kamenridercraft:breacookie player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 39 if score @s krc.form1n matches 1 run scoreboard players add @s krc.seq1 9
execute if score @s krc.seq1 matches 39 if score @s krc.form1n matches 2 run playsound kamenridercraft:bakibaki_stick player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 39 if score @s krc.form1n matches 2 run scoreboard players add @s krc.seq1 2
execute if score @s krc.seq1 matches 39 if score @s krc.form1n matches 3 run playsound kamenridercraft:marble_breacookie player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
