...
execute if entity @s[advancements={krc_snd:henshin/gavv/bitter_gochizo={gummy=true}}] run playsound kamenridercraft:bitter_gummy_gochizo player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @s[advancements={krc_snd:henshin/gavv/bitter_gochizo={cookie=true}}] run playsound kamenridercraft:bitter_cookie_gochizo player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if entity @s[advancements={krc_snd:henshin/gavv/bitter_gochizo={snack=true}}] run playsound kamenridercraft:bitter_snack_gochizo player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
