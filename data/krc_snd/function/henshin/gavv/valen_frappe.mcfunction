...
execute if score @s krc.form1n matches 0 unless score Form_Difference krc.form1n matches 1..4 run playsound kamenridercraft:frappe_custom player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.form1n matches 1 run playsound kamenridercraft:punchingummy_valen player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 2 run playsound kamenridercraft:kickingummy_valen player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[advancements={krc_snd:flags/gavv/temporary={punchin_kickin=false}}] krc.form1n matches 3 if score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:punchingummy_valen player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[advancements={krc_snd:flags/gavv/temporary={punchin_kickin=false}}] krc.form1n matches 3 if score Form_Difference krc.form1n matches -2 run playsound kamenridercraft:kickingummy_valen player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s[advancements={krc_snd:flags/gavv/temporary={punchin_kickin=true}}] krc.form1n matches 3 run playsound kamenridercraft:punchingummy_kickingummy_valen player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 4 run playsound kamenridercraft:gurucan_valen player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 5 run playsound kamenridercraft:parfait_mode player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
