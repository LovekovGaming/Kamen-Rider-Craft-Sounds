...
execute unless score @s krc.form1n matches 13..15 unless score @s krc.form1n matches 17 run playsound kamenridercraft:gochizo_pop_out player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 13 run playsound kamenridercraft:blizzardsorbet_pop_out player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 14..15 run playsound kamenridercraft:gochipod_pop_out player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 17 run playsound kamenridercraft:hexenheim_pop_out player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
