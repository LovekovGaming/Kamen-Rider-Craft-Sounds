...
execute if score @s krc.form1n matches 1.. unless score @s krc.form1n matches 18..25 run function krc_snd:play_global {name:"kamenridercraft:ziku-driver_spin",scope:"henshin_snd"}
execute if score @s krc.form1n matches 18..25 unless score @s krc.form1n matches 20..21 run function krc_snd:play_global {name:"kamenridercraft:ridewatch_insert",scope:"henshin_snd"}
execute if score @s krc.form1n matches 18..25 unless score @s krc.form1n matches 20..21 run function krc_snd:play_global {name:"kamenridercraft:final_form_time",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 20 unless score Form_Difference krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:ridewatch_insert",scope:"henshin_snd"}
execute if score @s krc.form1n matches 20 unless score Form_Difference krc.form1n matches 1 run function krc_snd:play_global {name:"kamenridercraft:final_form_time",scope:"henshin_snd"}
...
execute if score @s krc.form1n matches 21 unless score Form_Difference krc.form1n matches -1 run function krc_snd:play_global {name:"kamenridercraft:ridewatch_insert",scope:"henshin_snd"}
execute if score @s krc.form1n matches 21 unless score Form_Difference krc.form1n matches -1 run function krc_snd:play_global {name:"kamenridercraft:final_form_time",scope:"henshin_snd"}
