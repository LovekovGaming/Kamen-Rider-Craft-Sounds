...
execute if score @s krc.form1n matches 1.. unless score @s krc.form1n matches 18..25 run playsound kamenridercraft:ziku-driver_spin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 18..25 unless score @s krc.form1n matches 20..21 run playsound kamenridercraft:ridewatch_insert player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 18..25 unless score @s krc.form1n matches 20..21 run playsound kamenridercraft:final_form_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 20 unless score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:ridewatch_insert player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 20 unless score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:final_form_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 21 unless score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:ridewatch_insert player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 21 unless score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:final_form_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
