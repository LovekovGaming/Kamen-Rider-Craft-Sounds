...
execute if score @s krc.form1n matches 0 unless entity @s[advancements={krc_core:player_transformed=false}] run playsound kamenridercraft:ridewatch_out player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 1..11 unless score @s krc.form1n matches 9..10 run playsound kamenridercraft:ziku-driver_spin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 9 unless score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:ziku-driver_spin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 9 if predicate krc_core:sneaking if score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:ziku-driver_spin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 9 unless predicate krc_core:sneaking if score Form_Difference krc.form1n matches 1 run playsound kamenridercraft:powered_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.form1n matches 10 unless score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:ziku-driver_spin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 10 if predicate krc_core:sneaking if score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:ziku-driver_spin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.form1n matches 10 unless predicate krc_core:sneaking if score Form_Difference krc.form1n matches -1 run playsound kamenridercraft:speed_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
