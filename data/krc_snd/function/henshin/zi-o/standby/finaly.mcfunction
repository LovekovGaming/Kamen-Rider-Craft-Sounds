advancement revoke @s only krc_snd:henshin/zi-o/finaly_standby 2
...
execute if score @s krc.seq1 matches 46 run playsound kamenridercraft:finaly_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
