advancement revoke @s only krc_snd:henshin/zi-o/zonjis_seq 2
...
execute if score @s krc.seq1 matches 34 run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.zi-o.rider_time","color":"green"}
execute if score @s krc.seq1 matches 68 run playsound kamenridercraft:zonjis_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 96 run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.zi-o.zonjis","color":"green"}
execute if score @s krc.seq1 matches 136 run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.zi-o.zonjis","color":"green"}
...
advancement revoke @s only krc_snd:henshin/zi-o/zonjis_seq