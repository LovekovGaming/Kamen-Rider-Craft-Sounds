...
execute if score @s krc.seq1 matches 49 if score @s krc.form1n matches 0..3 run playsound kamenridercraft:future_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 49 if score @s krc.form1n matches 4..6 run playsound kamenridercraft:finaly_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 77 if score @s krc.form1n matches 0 run playsound kamenridercraft:woz_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 77 if score @s krc.form1n matches 1 run playsound kamenridercraft:futuring_shinobi player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 77 if score @s krc.form1n matches 2 run playsound kamenridercraft:futuring_quiz player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 77 if score @s krc.form1n matches 3 run playsound kamenridercraft:futuring_kikai player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 75 if score @s krc.form1n matches 4 run playsound kamenridercraft:wozgingafinaly player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 77 if score @s krc.form1n matches 5 run playsound kamenridercraft:wozgingataiyo player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 77 if score @s krc.form1n matches 6 run playsound kamenridercraft:wozgingawakusei player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
