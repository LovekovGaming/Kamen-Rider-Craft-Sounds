...
execute if items entity @s armor.feet kamenridercraft:another_build_driver run playsound kamenridercraft:another_build player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_ex_aid_driver run playsound kamenridercraft:another_ex-aid player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_ghost_driver run playsound kamenridercraft:another_ghost player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_gaim_driver run playsound kamenridercraft:another_gaim player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_wizard_driver run playsound kamenridercraft:another_wizard player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_fourze_driver run playsound kamenridercraft:another_fourze player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_ooo_driver run playsound kamenridercraft:another_ooo player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_w_driver run playsound kamenridercraft:another_w player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_decadriver run playsound kamenridercraft:another_decade player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_den_o_belt run playsound kamenridercraft:another_den-o player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_rider_belt run playsound kamenridercraft:another_kabuto player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_faiz_driver run playsound kamenridercraft:another_faiz player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_v_buckle_ryuki run playsound kamenridercraft:another_ryuki player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_v_buckle_ryuga run playsound kamenridercraft:another_ryuga player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_altering run playsound kamenridercraft:another_agito_watch player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_shinobi_driver run playsound kamenridercraft:another_shinobi player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if items entity @s armor.feet kamenridercraft:another_diendriver run playsound kamenridercraft:another_diend player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
