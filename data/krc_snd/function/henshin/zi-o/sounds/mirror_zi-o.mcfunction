...
execute if score @s krc.seq1 matches 34 run playsound kamenridercraft:emit_redir player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 68 run playsound kamenridercraft:mirror_zi-o_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
