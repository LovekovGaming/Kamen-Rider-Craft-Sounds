...
execute if score @s krc.seq1 matches 14 run playsound kamenridercraft:tsukuyomi_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 68 run playsound kamenridercraft:tsukuyomi_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
