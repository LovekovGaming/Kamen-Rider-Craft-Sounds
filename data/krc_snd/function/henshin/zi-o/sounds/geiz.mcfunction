...
execute if score @s krc.seq1 matches 14 if score @s krc.form1n matches 0..10 run playsound kamenridercraft:geiz_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 28 if score @s krc.form1n matches 0..8 run playsound kamenridercraft:geiz_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 48 if score @s krc.form1n matches 0..8 run playsound kamenridercraft:rider_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 82 if score @s krc.form1n matches 0..8 run playsound kamenridercraft:geiz_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 14 if score @s krc.form1n matches 0..8 run playsound kamenridercraft:geiz_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 70 if score @s krc.form1n matches 9 run playsound kamenridercraft:revive_goretsu player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 70 if score @s krc.form1n matches 10 run playsound kamenridercraft:revive_shippu player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 8 if score @s krc.form1n matches 11 run playsound kamenridercraft:geizmajesty_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 29 if score @s krc.form1n matches 11 run playsound kamenridercraft:majesty_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 156 if score @s krc.form1n matches 1..7 run playsound kamenridercraft:armor_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 156 if score @s krc.form1n matches 8 run playsound kamenridercraft:bibill_time player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
