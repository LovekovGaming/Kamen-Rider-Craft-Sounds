...
execute if score @s krc.seq1 matches 14 if score @s krc.form1n matches 0..10 run function krc_snd:play_global {name:"kamenridercraft:geiz_time",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 28 if score @s krc.form1n matches 0..8 run function krc_snd:play_global {name:"kamenridercraft:geiz_time",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 48 if score @s krc.form1n matches 0..8 run function krc_snd:play_global {name:"kamenridercraft:rider_time",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 82 if score @s krc.form1n matches 0..8 run function krc_snd:play_global {name:"kamenridercraft:geiz_henshin",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 14 if score @s krc.form1n matches 0..8 run function krc_snd:play_global {name:"kamenridercraft:geiz_time",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 70 if score @s krc.form1n matches 9 run function krc_snd:play_global {name:"kamenridercraft:revive_goretsu",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 70 if score @s krc.form1n matches 10 run function krc_snd:play_global {name:"kamenridercraft:revive_shippu",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 8 if score @s krc.form1n matches 11 run function krc_snd:play_global {name:"kamenridercraft:geizmajesty_time",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 29 if score @s krc.form1n matches 11 run function krc_snd:play_global {name:"kamenridercraft:majesty_time",scope:"henshin_snd"}
...
execute if score @s krc.seq1 matches 156 if score @s krc.form1n matches 1..7 run function krc_snd:play_global {name:"kamenridercraft:armor_time",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 156 if score @s krc.form1n matches 8 run function krc_snd:play_global {name:"kamenridercraft:bibill_time",scope:"henshin_snd"}
