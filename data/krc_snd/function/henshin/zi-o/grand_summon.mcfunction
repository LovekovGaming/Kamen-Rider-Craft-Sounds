advancement revoke @s only krc_snd:henshin/zi-o/grand_summon
...
execute if entity @n[type=kamenridercraft:grand_summon,tag=!sounded,distance=..2] run stopsound @a[scores={krc.configs.henshin_snd=1},distance=..20] player kamenridercraft:zi-o_standby
execute if entity @n[type=kamenridercraft:grand_summon,tag=!sounded,distance=..2] run stopsound @a[scores={krc.configs.henshin_snd=1},distance=..20] player kamenridercraft:future_standby
execute if entity @n[type=kamenridercraft:grand_summon,tag=!sounded,distance=..2] run stopsound @a[scores={krc.configs.henshin_snd=1},distance=..20] player kamenridercraft:grandzi-o_standby
execute if entity @n[type=kamenridercraft:grand_summon,tag=!sounded,distance=..2] run scoreboard players set @s krc.seq1 0
execute if entity @n[type=kamenridercraft:grand_summon,tag=!sounded,distance=..2] run advancement revoke @s only krc_snd:henshin/zi-o/zi-o_standby
execute if entity @n[type=kamenridercraft:grand_summon,tag=!sounded,distance=..2] run advancement revoke @s only krc_snd:henshin/zi-o/future_standby
execute if entity @n[type=kamenridercraft:grand_summon,tag=!sounded,distance=..2] run advancement revoke @s only krc_snd:henshin/zi-o/grandzi-o_standby
...
execute if entity @n[type=kamenridercraft:grand_summon,tag=!sounded,distance=..2] run playsound kamenridercraft:grand_zi-o_summon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
