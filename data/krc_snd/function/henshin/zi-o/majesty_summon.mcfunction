...
execute if entity @n[type=minecraft:item,predicate=krc_snd:valid_item,tag=!sounded,distance=..2] run function krc_snd:play_global {name:"kamenridercraft:grand_zi-o_summon",scope:"henshin_snd"}
