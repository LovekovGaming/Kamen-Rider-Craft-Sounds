...
advancement grant @s only krc_snd:henshin/zi-o/mirror_zi-o_seq 1
...
playsound kamenridercraft:ziku-driver_spin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
