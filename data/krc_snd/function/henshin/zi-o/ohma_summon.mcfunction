...
execute if entity @n[type=kamenridercraft:grand_summon,tag=!sounded,distance=..2] run function krc_snd:play_global {name:"kamenridercraft:ohma_zi-o_summon",scope:"henshin_snd"}
