...
execute if entity @n[type=kamenridercraft:grand_summon,tag=!sounded,distance=..2] run playsound kamenridercraft:ohma_zi-o_summon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
