...
execute if score @s krc.form1n matches 3 run playsound kamenridercraft:ride_x-eggs_4 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 7 run playsound kamenridercraft:ride_x-eggs_8 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 10 run playsound kamenridercraft:ride_x-eggs_11 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 18 run playsound kamenridercraft:harinezumi_seed_x-eggs player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.form1n matches 19 run playsound kamenridercraft:zou_seed_x-eggs player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
