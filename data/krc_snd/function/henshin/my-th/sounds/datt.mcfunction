...
execute if score @s krc.seq1 matches 25 run playsound kamenridercraft:ride_x-eggs_4_zodiac player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 46 run playsound kamenridercraft:slash_born_rider player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 133 run playsound kamenridercraft:ride_x-eggs_4_rider player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
