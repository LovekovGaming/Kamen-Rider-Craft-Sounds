...
execute if score @s krc.seq1 matches 25 run playsound kamenridercraft:ride_x-eggs_1_origin_zodiac player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 46 run playsound kamenridercraft:hammer_born_rider player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 166 run playsound kamenridercraft:ride_x-eggs_1_origin_rider player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
