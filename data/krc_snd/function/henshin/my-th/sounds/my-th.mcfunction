...
execute if score @s krc.form1n matches 19 if score @s krc.seq1 matches 13 run title @a[scores={krc.configs.sound_subs=1},distance=..20] actionbar {"translate":"sound.kamenridercraft.my-th.hedgehog","color":"gold"}
execute if score @s krc.form1n matches 19 if score @s krc.seq1 matches 13 run scoreboard players set @s krc.seq1 147
