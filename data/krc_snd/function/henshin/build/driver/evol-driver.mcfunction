...
playsound kamenridercraft:evol_driver_equip player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~ 3
execute if entity @s[advancements={krc_snd:henshin/build/evol-driver_equip_seq={name=true}}] run playsound kamenridercraft:evol_driver_name player @a[scores={krc.configs.equip_snd=1}] ~ ~1 ~ 3
