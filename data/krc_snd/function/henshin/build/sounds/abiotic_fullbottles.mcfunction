...
execute if score @s krc.seq1 matches 16 if entity @s[tag=tank] run playsound kamenridercraft:tank_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=diamond] run playsound kamenridercraft:diamond_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=gatling] run playsound kamenridercraft:gatling_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=comic] run playsound kamenridercraft:comic_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=rocket] run playsound kamenridercraft:rocket_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=shoubousha] run playsound kamenridercraft:shoubousha_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=soujiki] run playsound kamenridercraft:soujiki_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=lock] run playsound kamenridercraft:lock_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=densha] run playsound kamenridercraft:densha_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=light] run playsound kamenridercraft:light_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=robot] run playsound kamenridercraft:robot_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=smapho] run playsound kamenridercraft:smapho_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=keshigomu] run playsound kamenridercraft:keshigomu_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=helicopter] run playsound kamenridercraft:helicopter_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=watch] run playsound kamenridercraft:watch_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=televi] run playsound kamenridercraft:televi_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=camera] run playsound kamenridercraft:camera_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=reizoko] run playsound kamenridercraft:reizoko_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=mic] run playsound kamenridercraft:mic_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=cake] run playsound kamenridercraft:cake_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=ufo] run playsound kamenridercraft:ufo_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=jet] run playsound kamenridercraft:jet_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=pyramid] run playsound kamenridercraft:pyramid_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=senpuki] run playsound kamenridercraft:senpuki_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=skebo] run playsound kamenridercraft:sukebo_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=bike] run playsound kamenridercraft:bike_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=sensuikan] run playsound kamenridercraft:sensuikan_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=dryer] run playsound kamenridercraft:dryer_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=engine] run playsound kamenridercraft:engine_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=magnet] run playsound kamenridercraft:magnet_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=gold] run playsound kamenridercraft:gold_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=silver_dragon] run playsound kamenridercraft:dragon_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=usb_memory] run playsound kamenridercraft:usb_memory_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=medal] run playsound kamenridercraft:medal_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=parka] run playsound kamenridercraft:parka_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=game] run playsound kamenridercraft:game_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
