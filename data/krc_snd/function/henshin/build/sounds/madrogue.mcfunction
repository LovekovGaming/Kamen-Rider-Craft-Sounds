...
execute if score @s krc.seq1 matches 84 run playsound kamenridercraft:evol_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3

execute if score @s krc.seq1 matches 109 run playsound kamenridercraft:madrogue_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
