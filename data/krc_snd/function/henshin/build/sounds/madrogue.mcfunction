...
execute if score @s krc.seq1 matches 84 run function krc_snd:play_global {name:"kamenridercraft:evol_henshin",scope:"henshin_snd"}

execute if score @s krc.seq1 matches 109 run function krc_snd:play_global {name:"kamenridercraft:madrogue_henshin",scope:"henshin_snd"}
