...
execute if score @s krc.seq1 matches 109 run playsound kamenridercraft:over_flow player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 139 run playsound kamenridercraft:blood_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
