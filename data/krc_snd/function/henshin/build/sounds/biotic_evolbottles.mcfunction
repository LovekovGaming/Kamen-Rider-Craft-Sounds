...
execute if score @s krc.seq1 matches 16 if entity @s[tag=cobra] run playsound kamenridercraft:cobra_evolbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=dragon] run playsound kamenridercraft:dragon_evolbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=rabbit] run playsound kamenridercraft:rabbit_evolbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=koumori] run playsound kamenridercraft:koumori_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
