...
execute if score @s krc.seq1 matches 109 if score @s krc.form1n matches 0 run playsound kamenridercraft:grease_blizzard player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 109 if score @s krc.form1n matches 1 run playsound kamenridercraft:perfect_kingdom player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
