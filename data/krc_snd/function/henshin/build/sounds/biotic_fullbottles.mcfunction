...
execute if score @s krc.seq1 matches 16 if entity @s[tag=rabbit] run playsound kamenridercraft:rabbit_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=gorilla] run playsound kamenridercraft:gorilla_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=taka] run playsound kamenridercraft:taka_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=ninja] run playsound kamenridercraft:ninjya_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=panda] run playsound kamenridercraft:panda_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=harinezumi] run playsound kamenridercraft:harinezumi_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=lion] run playsound kamenridercraft:lion_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=dragon] run playsound kamenridercraft:dragon_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=kaizoku] run playsound kamenridercraft:kaizoku_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=octopus] run playsound kamenridercraft:octopus_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=phoenix] run playsound kamenridercraft:phoenix_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=wolf] run playsound kamenridercraft:wolf_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=unicorn] run playsound kamenridercraft:unicorn_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=rose] run playsound kamenridercraft:rose_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=turtle] run playsound kamenridercraft:turtle_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=kuma] run playsound kamenridercraft:kuma_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=kabutomushi] run playsound kamenridercraft:kabutomushi_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=spider] run playsound kamenridercraft:spider_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=dog] run playsound kamenridercraft:dog_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=santa_claus] run playsound kamenridercraft:santa_claus_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=tora] run playsound kamenridercraft:tora_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=kujira] run playsound kamenridercraft:kujira_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=shika] run playsound kamenridercraft:shika_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=kirin] run playsound kamenridercraft:kirin_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=penguin] run playsound kamenridercraft:penguin_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=same] run playsound kamenridercraft:same_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=hachi] run playsound kamenridercraft:hachi_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=sai] run playsound kamenridercraft:sai_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=bat] run playsound kamenridercraft:bat_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=obake] run playsound kamenridercraft:obake_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=scorpion] run playsound kamenridercraft:scorpion_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=gold_rabbit] run playsound kamenridercraft:rabbit_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=momotaros] run playsound kamenridercraft:momotaros_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=card] run playsound kamenridercraft:card_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=tantei] run playsound kamenridercraft:tantei_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=yujou] run playsound kamenridercraft:yujou_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=mahoutsukai] run playsound kamenridercraft:mahotsukai_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=orange] run playsound kamenridercraft:orange_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 16 if entity @s[tag=doctor] run playsound kamenridercraft:doctor_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
