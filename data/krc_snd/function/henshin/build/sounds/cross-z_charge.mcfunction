...
execute if score @s krc.seq1 matches 117 if score @s krc.form1n matches 0 run playsound kamenridercraft:dragon_in_cross-z_charge player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
