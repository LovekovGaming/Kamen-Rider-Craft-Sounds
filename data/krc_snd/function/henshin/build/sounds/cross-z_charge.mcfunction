...
execute if score @s krc.seq1 matches 117 if score @s krc.form1n matches 0 run function krc_snd:play_global {name:"kamenridercraft:dragon_in_cross-z_charge",scope:"henshin_snd"}
