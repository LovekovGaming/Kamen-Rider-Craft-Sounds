...
execute if score @s krc.seq1 matches 29 if score @s krc.form1n matches 0 run playsound kamenridercraft:remote_control_gear player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
execute if score @s krc.seq1 matches 29 if score @s krc.form1n matches 1 run playsound kamenridercraft:engine_running_gear player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
