...
execute if score @s krc.seq1 matches 84 unless score @s krc.form1n matches 4 run playsound kamenridercraft:evol_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 109 if score @s krc.form1n matches 0 run playsound kamenridercraft:evol_cobra player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 109 if score @s krc.form1n matches 1 run playsound kamenridercraft:evol_dragon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 109 if score @s krc.form1n matches 2 run playsound kamenridercraft:evol_rabbit player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 109 if score @s krc.form1n matches 3 run playsound kamenridercraft:evol_black_hole player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 109 if score @s krc.form1n matches 5 run playsound kamenridercraft:evol-x player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
