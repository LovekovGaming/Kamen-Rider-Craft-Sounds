...
execute if score @s krc.seq1 matches 109 if score @s krc.form1n matches 0 run playsound kamenridercraft:cross-z_henshin player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 109 if score @s krc.form1n matches 1 run playsound kamenridercraft:cross-z_magma player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 109 if score @s krc.form1n matches 2 run playsound kamenridercraft:great_cross-z player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 109 if score @s krc.form1n matches 3 run playsound kamenridercraft:cross-zevol player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
