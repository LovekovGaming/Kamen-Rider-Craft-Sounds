...
execute if score @s[tag=!hatsudoki] krc.seq1 matches 16 run playsound kamenridercraft:rider_system_evolbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=hatsudoki] krc.seq1 matches 16 run playsound kamenridercraft:hatsudoki_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!hatsudoki,tag=!evol_trigger] krc.seq1 matches 42 run playsound kamenridercraft:evol_driver_evolution player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=!hatsudoki,tag=evol_trigger] krc.seq1 matches 42 run playsound kamenridercraft:evol_driver_revolution player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=hatsudoki] krc.seq1 matches 42 run playsound kamenridercraft:evol_match player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
