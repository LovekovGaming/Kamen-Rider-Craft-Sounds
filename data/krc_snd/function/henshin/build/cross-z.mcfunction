...
advancement grant @s only krc_snd:henshin/build/cross-z_seq 1
...
stopsound @a[scores={krc.configs.henshin_snd=1},distance=..20] player kamenridercraft:cross-z_magma_standby_1
stopsound @a[scores={krc.configs.henshin_snd=1},distance=..20] player kamenridercraft:cross-z_magma_standby_2
stopsound @a[scores={krc.configs.henshin_snd=1},distance=..20] player kamenridercraft:muscle_galaxy_standby_1
stopsound @a[scores={krc.configs.henshin_snd=1},distance=..20] player kamenridercraft:muscle_galaxy_standby_2
