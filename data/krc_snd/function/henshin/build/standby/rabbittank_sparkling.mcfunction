...
execute if score @s krc.seq2 matches 16 run playsound kamenridercraft:rabbittank_sparkling_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq2 matches 55 run playsound kamenridercraft:rabbittank_sparkling_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
