...
execute if score @s krc.seq2 matches 16 run function krc_snd:play_global {name:"kamenridercraft:cross-zbuild_fullbottle",scope:"henshin_snd"}
...
execute if score @s krc.seq2 matches 48 run function krc_snd:play_global {name:"kamenridercraft:cross-zbuild_standby",scope:"henshin_snd"}
