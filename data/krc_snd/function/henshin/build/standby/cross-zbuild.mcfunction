...
execute if score @s krc.seq2 matches 16 run playsound kamenridercraft:cross-zbuild_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 48 run playsound kamenridercraft:cross-zbuild_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
