...
execute if score @s krc.seq2 matches 16 run playsound kamenridercraft:muscle_galaxy player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 49 run playsound kamenridercraft:muscle_galaxy_standby_1 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
