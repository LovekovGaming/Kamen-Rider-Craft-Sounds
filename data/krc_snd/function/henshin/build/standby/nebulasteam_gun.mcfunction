...
execute if score @s[advancements={krc_snd:henshin/build/nebulasteam_gun_standby={engine=true}}] krc.seq1 matches 31 run playsound kamenridercraft:gear_engine player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_snd:henshin/build/nebulasteam_gun_standby={remocon=true}}] krc.seq1 matches 26 run playsound kamenridercraft:gear_remocon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_snd:henshin/build/nebulasteam_gun_standby={engine_red=true}}] krc.seq1 matches 31 run playsound kamenridercraft:gear_engine player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_snd:henshin/build/nebulasteam_gun_standby={remocon_blue=true}}] krc.seq1 matches 26 run playsound kamenridercraft:gear_remocon player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.henshin-stage matches 3 if score @s krc.seq1 matches 53 run playsound kamenridercraft:funky_match player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq1 matches 83 run playsound kamenridercraft:nebulasteam_gun_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
