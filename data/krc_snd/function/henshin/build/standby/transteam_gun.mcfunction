...
execute if score @s[tag=bat] krc.seq1 matches 16 run playsound kamenridercraft:bat_fullbottle_2 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s[tag=cobra] krc.seq1 matches 16 run playsound kamenridercraft:cobra_fullbottle_2 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
...
execute if score @s krc.seq1 matches 34 run playsound kamenridercraft:transteam_gun_standby player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~
