...
execute if score @s[advancements={krc_snd:flags/build/temporary={tanktank=false}}] krc.seq2 matches 16 run playsound kamenridercraft:rabbitrabbit_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s[advancements={krc_snd:flags/build/temporary={tanktank=true}}] krc.seq2 matches 16 run playsound kamenridercraft:tanktank_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
playsound kamenridercraft:build_up player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
