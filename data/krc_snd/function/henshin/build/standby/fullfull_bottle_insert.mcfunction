...
execute if score @s[advancements={krc_snd:flags/build/temporary={tanktank=false}}] krc.seq2 matches 16 run function krc_snd:play_global {name:"kamenridercraft:rabbitrabbit_fullbottle",scope:"henshin_snd"}
...
execute if score @s[advancements={krc_snd:flags/build/temporary={tanktank=true}}] krc.seq2 matches 16 run function krc_snd:play_global {name:"kamenridercraft:tanktank_fullbottle",scope:"henshin_snd"}
...
function krc_snd:play_global {name:"kamenridercraft:build_up",scope:"henshin_snd"}
