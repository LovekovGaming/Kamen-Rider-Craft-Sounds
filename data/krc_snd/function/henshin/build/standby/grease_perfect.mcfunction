...
execute if score @s krc.seq2 matches 16 run function krc_snd:play_global {name:"kamenridercraft:grease_perfect",scope:"henshin_snd"}
...
execute if score @s krc.seq2 matches 49 run function krc_snd:play_global {name:"kamenridercraft:grease_perfect_standby",scope:"henshin_snd"}
