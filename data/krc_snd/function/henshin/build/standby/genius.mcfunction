...
execute if score @s krc.seq2 matches 16 run playsound kamenridercraft:genius_fullbottle player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
...
execute if score @s krc.seq2 matches 44 run playsound kamenridercraft:build_genius_standby_1 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
