...
execute if score @s krc.seq1 matches 76 run function krc_snd:play_global {name:"kamenridercraft:build_driver_standby_1",scope:"henshin_snd"}
execute if score @s krc.seq1 matches 77 run function krc_snd:play_global {name:"kamenridercraft:grease_blizzard_standby_1",scope:"henshin_snd"}
