...
execute if score @s krc.seq1 matches 76 run playsound kamenridercraft:build_driver_standby_1 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
execute if score @s krc.seq1 matches 77 run playsound kamenridercraft:grease_blizzard_standby_1 player @a[scores={krc.configs.henshin_snd=1}] ~ ~1 ~ 3
